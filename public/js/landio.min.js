var Util=function(a){function b(){return{bindType:c.end,delegateType:c.end,handle:function(b){if(a(b.target).is(this))return b.handleObj.handler.apply(this,arguments)}}}var c=!1,d={WebkitTransition:"webkitTransitionEnd",MozTransition:"transitionend",OTransition:"oTransitionEnd otransitionend",transition:"transitionend"},e={TRANSITION_END:"bsTransitionEnd",getUID:function(a){do a+=~~(1E6*Math.random());while(document.getElementById(a));return a},getSelectorFromElement:function(a){var b=a.getAttribute("data-target");
b||(b=a.getAttribute("href")||"",b=/^#[a-z]/i.test(b)?b:null);return b},reflow:function(a){(new Function("bs","return bs"))(a.offsetHeight)},triggerTransitionEnd:function(b){a(b).trigger(c.end)},supportsTransitionEnd:function(){return!!c},typeCheckConfig:function(a,b,c){for(var d in c)if(c.hasOwnProperty(d)){var e=c[d],l=b[d],p=void 0,p=l&&(l[0]||l).nodeType?"element":{}.toString.call(l).match(/\s([a-zA-Z]+)/)[1].toLowerCase();if(!(new RegExp(e)).test(p))throw Error(a.toUpperCase()+": "+('Option "'+
d+'" provided type "'+p+'" ')+('but expected type "'+e+'".'));}}},c=function(){if(window.QUnit)return!1;var a=document.createElement("bootstrap"),b;for(b in d)if(void 0!==a.style[b])return{end:d[b]};return!1}();a.fn.emulateTransitionEnd=function(b){var c=this,d=!1;a(this).one(e.TRANSITION_END,function(){d=!0});setTimeout(function(){d||e.triggerTransitionEnd(c)},b);return this};e.supportsTransitionEnd()&&(a.event.special[e.TRANSITION_END]=b());return e}(jQuery);"use strict";
var _createClass=function(){function a(a,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}return function(b,c,d){c&&a(b.prototype,c);d&&a(b,d);return b}}();function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}
var Carousel=function(a){var b=a.fn.carousel,c={interval:5E3,keyboard:!0,slide:!1,pause:"hover",wrap:!0},d={interval:"(number|boolean)",keyboard:"boolean",slide:"(boolean|string)",pause:"(string|boolean)",wrap:"boolean"},e=function(){function b(c,d){_classCallCheck(this,b);this._activeElement=this._interval=this._items=null;this._isSliding=this._isPaused=!1;this._config=this._getConfig(d);this._element=a(c)[0];this._indicatorsElement=a(this._element).find(".carousel-indicators")[0];this._addEventListeners()}
_createClass(b,[{key:"next",value:function(){this._isSliding||this._slide("next")}},{key:"prev",value:function(){this._isSliding||this._slide("prev")}},{key:"pause",value:function(b){b||(this._isPaused=!0);a(this._element).find(".next, .prev")[0]&&Util.supportsTransitionEnd()&&(Util.triggerTransitionEnd(this._element),this.cycle(!0));clearInterval(this._interval);this._interval=null}},{key:"cycle",value:function(b){b||(this._isPaused=!1);this._interval&&(clearInterval(this._interval),this._interval=
null);this._config.interval&&!this._isPaused&&(this._interval=setInterval(a.proxy(this.next,this),this._config.interval))}},{key:"to",value:function(b){var c=this;this._activeElement=a(this._element).find(".active.carousel-item")[0];var d=this._getItemIndex(this._activeElement);if(!(b>this._items.length-1||0>b))if(this._isSliding)a(this._element).one("slid.bs.carousel",function(){return c.to(b)});else d===b?(this.pause(),this.cycle()):this._slide(b>d?"next":"prev",this._items[b])}},{key:"dispose",
value:function(){a(this._element).off(".bs.carousel");a.removeData(this._element,"bs.carousel");this._indicatorsElement=this._activeElement=this._isSliding=this._isPaused=this._interval=this._element=this._config=this._items=null}},{key:"_getConfig",value:function(b){b=a.extend({},c,b);Util.typeCheckConfig("carousel",b,d);return b}},{key:"_addEventListeners",value:function(){if(this._config.keyboard)a(this._element).on("keydown.bs.carousel",a.proxy(this._keydown,this));if("hover"===this._config.pause&&
...
(b=this._indicatorsElement.children[this._getItemIndex(b)])&&a(b).addClass("active"))}},{key:"_slide",value:function(b,c){var d=this,e=a(this._element).find(".active.carousel-item")[0],f=c||e&&this._getItemByDirection(b,e),p=!!this._interval,n="next"===b?"left":"right";if(f&&a(f).hasClass("active"))this._isSliding=!1;else if(!this._triggerSlideEvent(f,n).isDefaultPrevented()&&e&&f){this._isSliding=!0;p&&this.pause();this._setActiveIndicatorElement(f);var q=a.Event("slid.bs.carousel",{relatedTarget:f,
direction:n});Util.supportsTransitionEnd()&&a(this._element).hasClass("slide")?(a(f).addClass(b),Util.reflow(f),a(e).addClass(n),a(f).addClass(n),a(e).one(Util.TRANSITION_END,function(){a(f).removeClass(n).removeClass(b);a(f).addClass("active");a(e).removeClass("active").removeClass(b).removeClass(n);d._isSliding=!1;setTimeout(function(){return a(d._element).trigger(q)},0)}).emulateTransitionEnd(600)):(a(e).removeClass("active"),a(f).addClass("active"),this._isSliding=!1,a(this._element).trigger(q));
p&&this.cycle()}}}],[{key:"_jQueryInterface",value:function(d){return this.each(function(){var e=a(this).data("bs.carousel"),k=a.extend({},c,a(this).data());"object"===typeof d&&a.extend(k,d);var m="string"===typeof d?d:k.slide;e||(e=new b(this,k),a(this).data("bs.carousel",e));if("number"===typeof d)e.to(d);else if(m)e[m]();else k.interval&&(e.pause(),e.cycle())})}},{key:"_dataApiClickHandler",value:function(c){var d=Util.getSelectorFromElement(this);if(d&&(d=a(d)[0])&&a(d).hasClass("carousel")){var e=
a.extend({},a(d).data(),a(this).data()),m=this.getAttribute("data-slide-to");m&&(e.interval=!1);b._jQueryInterface.call(a(d),e);m&&a(d).data("bs.carousel").to(m);c.preventDefault()}}},{key:"VERSION",get:function(){return"4.0.0"}},{key:"Default",get:function(){return c}}]);return b}();a(document).on("click.bs.carousel.data-api","[data-slide], [data-slide-to]",e._dataApiClickHandler);a(window).on("load.bs.carousel.data-api",function(){a('[data-ride="carousel"]').each(function(){var b=a(this);e._jQueryInterface.call(b,
b.data())})});a.fn.carousel=e._jQueryInterface;a.fn.carousel.Constructor=e;a.fn.carousel.noConflict=function(){a.fn.carousel=b;return e._jQueryInterface};return e}(jQuery);"use strict";_createClass=function(){function a(a,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}return function(b,c,d){c&&a(b.prototype,c);d&&a(b,d);return b}}();
function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}
var Collapse=function(a){var b=a.fn.collapse,c={toggle:!0,parent:""},d={toggle:"boolean",parent:"string"},e=function(){function b(c,d){_classCallCheck(this,b);this._isTransitioning=!1;this._element=c;this._config=this._getConfig(d);this._triggerArray=a.makeArray(a('[data-toggle="collapse"][href="#'+c.id+'"],'+('[data-toggle="collapse"][data-target="#'+c.id+'"]')));this._parent=this._config.parent?this._getParent():null;this._config.parent||this._addAriaAndCollapsedClass(this._element,this._triggerArray);
this._config.toggle&&this.toggle()}_createClass(b,[{key:"toggle",value:function(){a(this._element).hasClass("in")?this.hide():this.show()}},{key:"show",value:function(){var c=this;if(!this._isTransitioning&&!a(this._element).hasClass("in")){var d=void 0,e=void 0;this._parent&&(d=a.makeArray(a(".panel > .in, .panel > .collapsing")),d.length||(d=null));if(d&&(e=a(d).data("bs.collapse"))&&e._isTransitioning)return;var m=a.Event("show.bs.collapse");a(this._element).trigger(m);if(!m.isDefaultPrevented()){d&&
(b._jQueryInterface.call(a(d),"hide"),e||a(d).data("bs.collapse",null));var l=this._getDimension();a(this._element).removeClass("collapse").addClass("collapsing");this._element.style[l]=0;this._element.setAttribute("aria-expanded",!0);this._triggerArray.length&&a(this._triggerArray).removeClass("collapsed").attr("aria-expanded",!0);this.setTransitioning(!0);d=function(){a(c._element).removeClass("collapsing").addClass("collapse").addClass("in");c._element.style[l]="";c.setTransitioning(!1);a(c._element).trigger("shown.bs.collapse")};
Util.supportsTransitionEnd()?(e="scroll"+(l[0].toUpperCase()+l.slice(1)),a(this._element).one(Util.TRANSITION_END,d).emulateTransitionEnd(600),this._element.style[l]=this._element[e]+"px"):d()}}}},{key:"hide",value:function(){var b=this;if(!this._isTransitioning&&a(this._element).hasClass("in")){var c=a.Event("hide.bs.collapse");a(this._element).trigger(c);if(!c.isDefaultPrevented()){c=this._getDimension();this._element.style[c]=this._element["width"===c?"offsetWidth":"offsetHeight"]+"px";Util.reflow(this._element);
a(this._element).addClass("collapsing").removeClass("collapse").removeClass("in");this._element.setAttribute("aria-expanded",!1);this._triggerArray.length&&a(this._triggerArray).addClass("collapsed").attr("aria-expanded",!1);this.setTransitioning(!0);var d=function(){b.setTransitioning(!1);a(b._element).removeClass("collapsing").addClass("collapse").trigger("hidden.bs.collapse")};this._element.style[c]=0;Util.supportsTransitionEnd()?a(this._element).one(Util.TRANSITION_END,d).emulateTransitionEnd(600):
d()}}}},{key:"setTransitioning",value:function(a){this._isTransitioning=a}},{key:"dispose",value:function(){a.removeData(this._element,"bs.collapse");this._isTransitioning=this._triggerArray=this._element=this._parent=this._config=null}},{key:"_getConfig",value:function(b){b=a.extend({},c,b);b.toggle=!!b.toggle;Util.typeCheckConfig("collapse",b,d);return b}},{key:"_getDimension",value:function(){return a(this._element).hasClass("width")?"width":"height"}},{key:"_getParent",value:function(){var c=
this,d=a(this._config.parent)[0],e='[data-toggle="collapse"][data-parent="'+this._config.parent+'"]';a(d).find(e).each(function(a,d){c._addAriaAndCollapsedClass(b._getTargetFromElement(d),[d])});return d}},{key:"_addAriaAndCollapsedClass",value:function(b,c){if(b){var d=a(b).hasClass("in");b.setAttribute("aria-expanded",d);c.length&&a(c).toggleClass("collapsed",!d).attr("aria-expanded",d)}}}],[{key:"_getTargetFromElement",value:function(b){return(b=Util.getSelectorFromElement(b))?a(b)[0]:null}},{key:"_jQueryInterface",
value:function(d){return this.each(function(){var e=a(this),k=e.data("bs.collapse"),m=a.extend({},c,e.data(),"object"===typeof d&&d);!k&&m.toggle&&/show|hide/.test(d)&&(m.toggle=!1);k||(k=new b(this,m),e.data("bs.collapse",k));if("string"===typeof d)k[d]()})}},{key:"VERSION",get:function(){return"4.0.0"}},{key:"Default",get:function(){return c}}]);return b}();a(document).on("click.bs.collapse.data-api",'[data-toggle="collapse"]',function(b){b.preventDefault();b=e._getTargetFromElement(this);var c=
a(b).data("bs.collapse")?"toggle":a(this).data();e._jQueryInterface.call(a(b),c)});a.fn.collapse=e._jQueryInterface;a.fn.collapse.Constructor=e;a.fn.collapse.noConflict=function(){a.fn.collapse=b;return e._jQueryInterface};return e}(jQuery);"use strict";_createClass=function(){function a(a,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}return function(b,c,d){c&&a(b.prototype,c);d&&a(b,d);return b}}();
function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}
var Dropdown=function(a){var b=a.fn.dropdown,c=function(){function b(a){_classCallCheck(this,b);this._element=a;this._addEventListeners()}_createClass(b,[{key:"toggle",value:function(){if(this.disabled||a(this).hasClass("disabled"))return!1;var c=b._getParentFromElement(this),f=a(c).hasClass("open");b._clearMenus();if(f)return!1;"ontouchstart"in document.documentElement&&!a(c).closest(".navbar-nav").length&&(f=document.createElement("div"),f.className="dropdown-backdrop",a(f).insertBefore(this),a(f).on("click",
b._clearMenus));var f={relatedTarget:this},g=a.Event("show.bs.dropdown",f);a(c).trigger(g);if(g.isDefaultPrevented())return!1;this.focus();this.setAttribute("aria-expanded","true");a(c).toggleClass("open");a(c).trigger(a.Event("shown.bs.dropdown",f));return!1}},{key:"dispose",value:function(){a.removeData(this._element,"bs.dropdown");a(this._element).off(".bs.dropdown");this._element=null}},{key:"_addEventListeners",value:function(){a(this._element).on("click.bs.dropdown",this.toggle)}}],[{key:"_jQueryInterface",
value:function(c){return this.each(function(){var f=a(this).data("bs.dropdown");f||a(this).data("bs.dropdown",f=new b(this));"string"===typeof c&&f[c].call(this)})}},{key:"_clearMenus",value:function(c){if(!c||3!==c.which){var f=a(".dropdown-backdrop")[0];f&&f.parentNode.removeChild(f);for(var f=a.makeArray(a('[data-toggle="dropdown"]')),g=0;g<f.length;g++){var h=b._getParentFromElement(f[g]),k={relatedTarget:f[g]};if(a(h).hasClass("open")&&!(c&&"click"===c.type&&/input|textarea/i.test(c.target.tagName)&&
a.contains(h,c.target))){var m=a.Event("hide.bs.dropdown",k);a(h).trigger(m);m.isDefaultPrevented()||(f[g].setAttribute("aria-expanded","false"),a(h).removeClass("open").trigger(a.Event("hidden.bs.dropdown",k)))}}}}},{key:"_getParentFromElement",value:function(b){var c=void 0,d=Util.getSelectorFromElement(b);d&&(c=a(d)[0]);return c||b.parentNode}},{key:"_dataApiKeydownHandler",value:function(c){if(/(38|40|27|32)/.test(c.which)&&!/input|textarea/i.test(c.target.tagName)&&(c.preventDefault(),c.stopPropagation(),
!this.disabled&&!a(this).hasClass("disabled"))){var f=b._getParentFromElement(this),g=a(f).hasClass("open");!g&&27!==c.which||g&&27===c.which?(27===c.which&&(c=a(f).find('[data-toggle="dropdown"]')[0],a(c).trigger("focus")),a(this).trigger("click")):(f=a.makeArray(a('[role="menu"] li:not(.disabled) a, [role="listbox"] li:not(.disabled) a')),f=f.filter(function(a){return a.offsetWidth||a.offsetHeight}),f.length&&(g=f.indexOf(c.target),38===c.which&&0<g&&g--,40===c.which&&g<f.length-1&&g++,~g||(g=0),
f[g].focus()))}}},{key:"VERSION",get:function(){return"4.0.0"}}]);return b}();a(document).on("keydown.bs.dropdown.data-api",'[data-toggle="dropdown"]',c._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api",'[role="menu"]',c._dataApiKeydownHandler).on("keydown.bs.dropdown.data-api",'[role="listbox"]',c._dataApiKeydownHandler).on("click.bs.dropdown.data-api",c._clearMenus).on("click.bs.dropdown.data-api",'[data-toggle="dropdown"]',c.prototype.toggle).on("click.bs.dropdown.data-api",".dropdown form",
function(a){a.stopPropagation()});a.fn.dropdown=c._jQueryInterface;a.fn.dropdown.Constructor=c;a.fn.dropdown.noConflict=function(){a.fn.dropdown=b;return c._jQueryInterface};return c}(jQuery);"use strict";_createClass=function(){function a(a,c){for(var d=0;d<c.length;d++){var e=c[d];e.enumerable=e.enumerable||!1;e.configurable=!0;"value"in e&&(e.writable=!0);Object.defineProperty(a,e.key,e)}}return function(b,c,d){c&&a(b.prototype,c);d&&a(b,d);return b}}();
function _classCallCheck(a,b){if(!(a instanceof b))throw new TypeError("Cannot call a class as a function");}
var Modal=function(a){var b=a.fn.modal,c={backdrop:!0,keyboard:!0,focus:!0,show:!0},d={backdrop:"(boolean|string)",keyboard:"boolean",focus:"boolean",show:"boolean"},e=function(){function b(c,d){_classCallCheck(this,b);this._config=this._getConfig(d);this._element=c;this._dialog=a(c).find(".modal-dialog")[0];this._backdrop=null;this._ignoreBackdropClick=this._isBodyOverflowing=this._isShown=!1;this._scrollbarWidth=this._originalBodyPadding=0}_createClass(b,[{key:"toggle",value:function(a){return this._isShown?
this.hide():this.show(a)}},{key:"show",value:function(b){var c=this,d=a.Event("show.bs.modal",{relatedTarget:b});a(this._element).trigger(d);this._isShown||d.isDefaultPrevented()||(this._isShown=!0,this._checkScrollbar(),this._setScrollbar(),a(document.body).addClass("modal-open"),this._setEscapeEvent(),this._setResizeEvent(),a(this._element).on("click.dismiss.bs.modal",'[data-dismiss="modal"]',a.proxy(this.hide,this)),a(this._dialog).on("mousedown.dismiss.bs.modal",function(){a(c._element).one("mouseup.dismiss.bs.modal",
function(b){a(b.target).is(c._element)&&(that._ignoreBackdropClick=!0)})}),this._showBackdrop(a.proxy(this._showElement,this,b)))}},{key:"hide",value:function(b){b&&b.preventDefault();b=a.Event("hide.bs.modal");a(this._element).trigger(b);this._isShown&&!b.isDefaultPrevented()&&(this._isShown=!1,this._setEscapeEvent(),this._setResizeEvent(),a(document).off("focusin.bs.modal"),a(this._element).removeClass("in"),a(this._element).off("click.dismiss.bs.modal"),a(this._dialog).off("mousedown.dismiss.bs.modal"),
Util.supportsTransitionEnd()&&a(this._element).hasClass("fade")?a(this._element).one(Util.TRANSITION_END,a.proxy(this._hideModal,this)).emulateTransitionEnd(300):this._hideModal())}},{key:"dispose",value:function(){a.removeData(this._element,"bs.modal");a(window).off(".bs.modal");a(document).off(".bs.modal");a(this._element).off(".bs.modal");a(this._backdrop).off(".bs.modal");this._scrollbarWidth=this._originalBodyPadding=this._ignoreBackdropClick=this._isBodyOverflowing=this._isShown=this._backdrop=
this._dialog=this._element=this._config=null}},{key:"_getConfig",value:function(b){b=a.extend({},c,b);Util.typeCheckConfig("modal",b,d);return b}},{key:"_showElement",value:function(b){var c=this,d=Util.supportsTransitionEnd()&&a(this._element).hasClass("fade");this._element.parentNode&&this._element.parentNode.nodeType===Node.ELEMENT_NODE||document.body.appendChild(this._element);this._element.style.display="block";this._element.scrollTop=0;d&&Util.reflow(this._element);a(this._element).addClass("in");
this._config.focus&&this._enforceFocus();var e=a.Event("shown.bs.modal",{relatedTarget:b});b=function(){c._config.focus&&c._element.focus();a(c._element).trigger(e)};d?a(this._dialog).one(Util.TRANSITION_END,b).emulateTransitionEnd(300):b()}},{key:"_enforceFocus",value:function(){var b=this;a(document).off("focusin.bs.modal").on("focusin.bs.modal",function(c){b._element===c.target||a(b._element).has(c.target).length||b._element.focus()})}},{key:"_setEscapeEvent",value:function(){var b=this;if(this._isShown&&
this._config.keyboard)a(this._element).on("keydown.dismiss.bs.modal",function(a){27===a.which&&b.hide()});else this._isShown||a(this._element).off("keydown.dismiss.bs.modal")}},{key:"_setResizeEvent",value:function(){if(this._isShown)a(window).on("resize.bs.modal",a.proxy(this._handleUpdate,this));else a(window).off("resize.bs.modal")}},{key:"_hideModal",value:function(){var b=this;this._element.style.display="none";this._showBackdrop(function(){a(document.body).removeClass("modal-open");b._resetAdjustments();
b._resetScrollbar();a(b._element).trigger("hidden.bs.modal")})}},{key:"_removeBackdrop",value:function(){this._backdrop&&(a(this._backdrop).remove(),this._backdrop=null)}},{key:"_showBackdrop",value:function(b){var c=this,d=a(this._element).hasClass("fade")?"fade":"";if(this._isShown&&this._config.backdrop){var e=Util.supportsTransitionEnd()&&d;this._backdrop=document.createElement("div");this._backdrop.className="modal-backdrop";d&&a(this._backdrop).addClass(d);a(this._backdrop).appendTo(document.body);
a(this._element).on("click.dismiss.bs.modal",function(a){c._ignoreBackdropClick?c._ignoreBackdropClick=!1:a.target===a.currentTarget&&("static"===c._config.backdrop?c._element.focus():c.hide())});e&&Util.reflow(this._backdrop);a(this._backdrop).addClass("in");b&&(e?a(this._backdrop).one(Util.TRANSITION_END,b).emulateTransitionEnd(150):b())}else!this._isShown&&this._backdrop?(a(this._backdrop).removeClass("in"),d=function(){c._removeBackdrop();b&&b()},Util.supportsTransitionEnd()&&a(this._element).hasClass("fade")?
a(this._backdrop).one(Util.TRANSITION_END,d).emulateTransitionEnd(150):d()):b&&b()}},{key:"_handleUpdate",value:function(){this._adjustDialog()}},{key:"_adjustDialog",value:function(){var a=this._element.scrollHeight>document.documentElement.clientHeight;!this._isBodyOverflowing&&a&&(this._element.style.paddingLeft=this._scrollbarWidth+"px");this._isBodyOverflowing&&!a&&(this._element.style.paddingRight=this._scrollbarWidth+"px~")}},{key:"_resetAdjustments",value:function(){this._element.style.paddingLeft=
...
(document.body.style.paddingRight=b+(this._scrollbarWidth+"px"))}},{key:"_resetScrollbar",value:function(){document.body.style.paddingRight=this._originalBodyPadding}},{key:"_getScrollbarWidth",value:function(){var a=document.createElement("div");a.className="modal-scrollbar-measure";document.body.appendChild(a);var b=a.offsetWidth-a.clientWidth;document.body.removeChild(a);return b}}],[{key:"_jQueryInterface",value:function(c,d){return this.each(function(){var e=a(this).data("bs.modal"),m=a.extend({},
b.Default,a(this).data(),"object"===typeof c&&c);e||(e=new b(this,m),a(this).data("bs.modal",e));if("string"===typeof c)e[c](d);else m.show&&e.show(d)})}},{key:"VERSION",get:function(){return"4.0.0"}},{key:"Default",get:function(){return c}}]);return b}();a(document).on("click.bs.modal.data-api",'[data-toggle="modal"]',function(b){var c=this,d=void 0,k=Util.getSelectorFromElement(this);k&&(d=a(k)[0]);k=a(d).data("bs.modal")?"toggle":a.extend({},a(d).data(),a(this).data());"A"===this.tagName&&b.preventDefault();
var m=a(d).one("show.bs.modal",function(b){if(!b.isDefaultPrevented())m.one("hidden.bs.modal",function(){a(c).is(":visible")&&c.focus()})});e._jQueryInterface.call(a(d),k,this)});a.fn.modal=e._jQueryInterface;a.fn.modal.Constructor=e;a.fn.modal.noConflict=function(){a.fn.modal=b;return e._jQueryInterface};return e}(jQuery);
...
function(){this.context.remove(this);this.group.remove(this);delete c[this.key]};a.prototype.disable=function(){return this.enabled=!1,this};a.prototype.enable=function(){return this.context.refresh(),this.enabled=!0,this};a.prototype.next=function(){return this.group.next(this)};a.prototype.previous=function(){return this.group.previous(this)};a.invokeAll=function(a){var b=[],f;for(f in c)b.push(c[f]);f=0;for(var g=b.length;g>f;f++)b[f][a]()};a.destroyAll=function(){a.invokeAll("destroy")};a.disableAll=
...
c={};this.handleScroll();a={horizontal:{contextOffset:a?0:b.left,contextScroll:a?0:this.oldScroll.x,contextDimension:this.innerWidth(),oldScroll:this.oldScroll.x,forward:"right",backward:"left",offsetProp:"left"},vertical:{contextOffset:a?0:b.top,contextScroll:a?0:this.oldScroll.y,contextDimension:this.innerHeight(),oldScroll:this.oldScroll.y,forward:"down",backward:"up",offsetProp:"top"}};for(var d in a){var b=a[d],f;for(f in this.waypoints[d]){var p,n,q,r=this.waypoints[d][f];q=r.options.offset;
p=r.triggerPoint;n=0;var x=null==p;r.element!==r.element.window&&(n=r.adapter.offset()[b.offsetProp]);"function"==typeof q?q=q.apply(r):"string"==typeof q&&(q=parseFloat(q),-1<r.options.offset.indexOf("%")&&(q=Math.ceil(b.contextDimension*q/100)));r.triggerPoint=n+(b.contextScroll-b.contextOffset)-q;p=p<b.oldScroll;n=r.triggerPoint>=b.oldScroll;q=p&&n;p=!p&&!n;!x&&q?(r.queueTrigger(b.backward),c[r.group.id]=r.group):!x&&p?(r.queueTrigger(b.forward),c[r.group.id]=r.group):x&&b.oldScroll>=r.triggerPoint&&
(r.queueTrigger(b.forward),c[r.group.id]=r.group)}}return e.requestAnimationFrame(function(){for(var a in c)c[a].flushTriggers()}),this};b.findOrCreateByElement=function(a){return b.findByElement(a)||new b(a)};b.refreshAll=function(){for(var a in d)d[a].refresh()};b.findByElement=function(a){return d[a.waypointContextKey]};window.onload=function(){f&&f();b.refreshAll()};e.requestAnimationFrame=function(b){(window.requestAnimationFrame||window.mozRequestAnimationFrame||window.webkitRequestAnimationFrame||
...
(function(){function a(a){return function(d,e){var f=[],g=d;return a.isFunction(d)&&(g=a.extend({},e),g.handler=d),this.each(function(){var d=a.extend({},g,{element:this});"string"==typeof d.context&&(d.context=a(this).closest(d.context)[0]);f.push(new b(d))}),f}}var b=window.Waypoint;window.jQuery&&(window.jQuery.fn.waypoint=a(window.jQuery));window.Zepto&&(window.Zepto.fn.waypoint=a(window.Zepto))})();
(function(a){"function"===typeof define&&define.amd?define(["jquery"],a):"object"===typeof module&&module.exports?a(require("jquery")):a(jQuery)})(function(a){function b(b){var c={},d=/^jQuery\d+$/;a.each(b.attributes,function(a,b){b.specified&&!d.test(b.name)&&(c[b.name]=b.value)});return c}function c(b,c){var d=a(this);if(this.value===d.attr("placeholder")&&d.hasClass(l.customClass))if(this.value="",d.removeClass(l.customClass),d.data("placeholder-password")){d=d.hide().nextAll('input[type="password"]:first').show().attr("id",
d.removeAttr("id").data("placeholder-id"));if(!0===b)return d[0].value=c;d.focus()}else this==e()&&this.select()}function d(d){var e,f=a(this),g=this.id;if(d&&"blur"===d.type&&(f.hasClass(l.customClass)||"password"===this.type&&(e=f.prevAll('input[type="text"]:first'),0<e.length&&e.is(":visible"))))return;if(""===this.value){if("password"===this.type){if(!f.data("placeholder-textinput")){try{e=f.clone().prop({type:"text"})}catch(h){e=a("<input>").attr(a.extend(b(this),{type:"text"}))}e.removeAttr("name").data({"placeholder-enabled":!0,
"placeholder-password":f,"placeholder-id":g}).bind("focus.placeholder",c);f.data({"placeholder-textinput":e,"placeholder-id":g}).before(e)}this.value="";f=f.removeAttr("id").hide().prevAll('input[type="text"]:first').attr("id",f.data("placeholder-id")).show()}else if(d=f.data("placeholder-password"))d[0].value="",f.attr("id",f.data("placeholder-id")).show().nextAll('input[type="password"]:last').hide().removeAttr("id");f.addClass(l.customClass);f[0].value=f.attr("placeholder")}else f.removeClass(l.customClass)}
function e(){try{return document.activeElement}catch(a){}}var f="[object OperaMini]"===Object.prototype.toString.call(window.operamini),g="placeholder"in document.createElement("input")&&!f,f="placeholder"in document.createElement("textarea")&&!f,h=a.valHooks,k=a.propHooks,m,l={};g&&f?(m=a.fn.placeholder=function(){return this},m.input=!0,m.textarea=!0):(m=a.fn.placeholder=function(b){l=a.extend({},{customClass:"placeholder"},b);return this.filter((g?"textarea":":input")+"[placeholder]").not("."+
l.customClass).bind({"focus.placeholder":c,"blur.placeholder":d}).data("placeholder-enabled",!0).trigger("blur.placeholder")},m.input=g,m.textarea=f,m={get:function(b){var c=a(b),d=c.data("placeholder-password");return d?d[0].value:c.data("placeholder-enabled")&&c.hasClass(l.customClass)?"":b.value},set:function(b,f){var g=a(b),h,k;""!==f&&(h=g.data("placeholder-textinput"),k=g.data("placeholder-password"),h?(c.call(h[0],!0,f)||(b.value=f),h[0].value=f):k&&(c.call(b,!0,f)||(k[0].value=f),b.value=
f));if(!g.data("placeholder-enabled"))return b.value=f,g;""===f?(b.value=f,b!=e()&&d.call(b)):(g.hasClass(l.customClass)&&c.call(b),b.value=f);return g}},g||(h.input=m,k.value=m),f||(h.textarea=m,k.value=m),a(function(){a(document).delegate("form","submit.placeholder",function(){var b=a("."+l.customClass,this).each(function(){c.call(this,!0,"")});setTimeout(function(){b.each(d)},10)})}),a(window).bind("beforeunload.placeholder",function(){a("."+l.customClass).each(function(){this.value=""})}))});
document.createElement("video");document.createElement("audio");document.createElement("track");
var vjs=function(a,b,c){if("string"===typeof a){0===a.indexOf("#")&&(a=a.slice(1));if(vjs.players[a])return b&&vjs.log.warn('Player "'+a+'" is already initialised. Options will not be applied.'),c&&vjs.players[a].ready(c),vjs.players[a];a=vjs.el(a)}if(!a||!a.nodeName)throw new TypeError("The element or ID supplied is not valid. (videojs)");return a.player||new vjs.Player(a,b,c)},videojs=window.videojs=vjs;vjs.CDN_VERSION="4.12";vjs.ACCESS_PROTOCOL="https:"==document.location.protocol?"https://":"http://";
vjs.VERSION="4.12.11";vjs.options={techOrder:["html5","flash"],html5:{},flash:{},width:300,height:150,defaultVolume:0,playbackRates:[],inactivityTimeout:2E3,children:{mediaLoader:{},posterImage:{},loadingSpinner:{},textTrackDisplay:{},bigPlayButton:{},controlBar:{},errorDisplay:{},textTrackSettings:{}},language:document.getElementsByTagName("html")[0].getAttribute("lang")||navigator.languages&&navigator.languages[0]||navigator.userLanguage||navigator.language||"en",languages:{},notSupportedMessage:"No compatible source was found for this video."};
...
vjs.removeClass=function(a,b){var c,d;if(vjs.hasClass(a,b)){c=a.className.split(" ");for(d=c.length-1;0<=d;d--)c[d]===b&&c.splice(d,1);a.className=c.join(" ")}};vjs.TEST_VID=vjs.createEl("video");(function(){var a=document.createElement("track");a.kind="captions";a.srclang="en";a.label="English";vjs.TEST_VID.appendChild(a)})();vjs.USER_AGENT=navigator.userAgent;vjs.IS_IPHONE=/iPhone/i.test(vjs.USER_AGENT);vjs.IS_IPAD=/iPad/i.test(vjs.USER_AGENT);vjs.IS_IPOD=/iPod/i.test(vjs.USER_AGENT);
...
vjs.IS_FIREFOX=/Firefox/i.test(vjs.USER_AGENT);vjs.IS_CHROME=/Chrome/i.test(vjs.USER_AGENT);vjs.IS_IE8=/MSIE\s8\.0/.test(vjs.USER_AGENT);vjs.TOUCH_ENABLED=!!("ontouchstart"in window||window.DocumentTouch&&document instanceof window.DocumentTouch);vjs.BACKGROUND_SIZE_SUPPORTED="backgroundSize"in vjs.TEST_VID.style;vjs.setElementAttributes=function(a,b){vjs.obj.each(b,function(b,d){null===d||"undefined"===typeof d||!1===d?a.removeAttribute(b):a.setAttribute(b,!0===d?"":d)})};
...
vjs.round=function(a,b){b||(b=0);return Math.round(a*Math.pow(10,b))/Math.pow(10,b)};vjs.createTimeRange=function(a,b){return void 0===a&&void 0===b?{length:0,start:function(){throw Error("This TimeRanges object is empty");},end:function(){throw Error("This TimeRanges object is empty");}}:{length:1,start:function(){return a},end:function(){return b}}};
...
vjs.xhr=function(a,b){var c,d,e,f,g,h,k;"string"===typeof a&&(a={uri:a});videojs.util.mergeOptions({method:"GET",timeout:45E3},a);b=b||function(){};h=function(){window.clearTimeout(g);b(null,d,d.response||d.responseText)};k=function(a){window.clearTimeout(g);a&&"string"!==typeof a||(a=Error(a));b(a,d)};c=window.XMLHttpRequest;"undefined"===typeof c&&(c=function(){try{return new window.ActiveXObject("Msxml2.XMLHTTP.6.0")}catch(a){}try{return new window.ActiveXObject("Msxml2.XMLHTTP.3.0")}catch(a){}try{return new window.ActiveXObject("Msxml2.XMLHTTP")}catch(a){}throw Error("This browser does not support XMLHttpRequest.");});
d=new c;d.uri=a.uri;c=vjs.parseUrl(a.uri);e=window.location;c.protocol+c.host===e.protocol+e.host||!window.XDomainRequest||"withCredentials"in d?(f="file:"==c.protocol||"file:"==e.protocol,d.onreadystatechange=function(){if(4===d.readyState){if(d.timedout)return k("timeout");200===d.status||f&&0===d.status?h():k()}},a.timeout&&(g=window.setTimeout(function(){4!==d.readyState&&(d.timedout=!0,d.abort())},a.timeout))):(d=new window.XDomainRequest,d.onload=h,d.onerror=k,d.onprogress=function(){},d.ontimeout=
function(){});try{d.open(a.method||"GET",a.uri,!0)}catch(m){return k(m)}a.withCredentials&&(d.withCredentials=!0);a.responseType&&(d.responseType=a.responseType);try{d.send()}catch(m){return k(m)}return d};vjs.util={};vjs.util.mergeOptions=function(a,b){var c,d,e;a=vjs.obj.copy(a);for(c in b)b.hasOwnProperty(c)&&(d=a[c],e=b[c],vjs.obj.isPlain(d)&&vjs.obj.isPlain(e)?a[c]=vjs.util.mergeOptions(d,e):a[c]=b[c]);return a};vjs.EventEmitter=function(){};vjs.EventEmitter.prototype.allowedEvents_={};
vjs.EventEmitter.prototype.on=function(a,b){var c=this.addEventListener;this.addEventListener=Function.prototype;vjs.on(this,a,b);this.addEventListener=c};vjs.EventEmitter.prototype.addEventListener=vjs.EventEmitter.prototype.on;vjs.EventEmitter.prototype.off=function(a,b){vjs.off(this,a,b)};vjs.EventEmitter.prototype.removeEventListener=vjs.EventEmitter.prototype.off;vjs.EventEmitter.prototype.one=function(a,b){vjs.one(this,a,b)};
vjs.EventEmitter.prototype.trigger=function(a){var b=a.type||a;"string"===typeof a&&(a={type:b});a=vjs.fixEvent(a);if(this.allowedEvents_[b]&&this["on"+b])this["on"+b](a);vjs.trigger(this,a)};vjs.EventEmitter.prototype.dispatchEvent=vjs.EventEmitter.prototype.trigger;
...
vjs.Component.prototype.emitTapEvents=function(){var a,b,c,d,e,f,g,h;a=0;b=null;this.on("touchstart",function(c){1===c.touches.length&&(b=vjs.obj.copy(c.touches[0]),a=(new Date).getTime(),d=!0)});this.on("touchmove",function(a){1<a.touches.length?d=!1:b&&(f=a.touches[0].pageX-b.pageX,g=a.touches[0].pageY-b.pageY,h=Math.sqrt(f*f+g*g),10<h&&(d=!1))});e=function(){d=!1};this.on("touchleave",e);this.on("touchcancel",e);this.on("touchend",function(e){b=null;!0===d&&(c=(new Date).getTime()-a,200>c&&(e.preventDefault(),
...
vjs.Slider.prototype.update=function(){if(this.el_){var a,b=this.getPercent(),c=this.handle,d=this.bar;if("number"!==typeof b||b!==b||0>b||Infinity===b)b=0;a=b;if(c){a=this.el_.offsetWidth;var e=c.el().offsetWidth;a=e?e/a:0;b*=1-a;a=b+a/2;c.el().style.left=vjs.round(100*b,2)+"%"}d&&(d.el().style.width=vjs.round(100*a,2)+"%")}};
...
vjs.MenuButton=vjs.Button.extend({init:function(a,b){vjs.Button.call(this,a,b);this.update();this.on("keydown",this.onKeyPress);this.el_.setAttribute("aria-haspopup",!0);this.el_.setAttribute("role","button")}});vjs.MenuButton.prototype.update=function(){var a=this.createMenu();this.menu&&this.removeChild(this.menu);this.menu=a;this.addChild(a);this.items&&0===this.items.length?this.hide():this.items&&1<this.items.length&&this.show()};vjs.MenuButton.prototype.buttonPressed_=!1;
...
vjs.Player.prototype.selectSource=function(a){for(var b=0,c=this.options_.techOrder;b<c.length;b++){var d=vjs.capitalize(c[b]),e=window.videojs[d];if(!e)vjs.log.error('The "'+d+'" tech is undefined. Skipped browser support check for that tech.');else if(e.isSupported())for(var f=0,g=a;f<g.length;f++){var h=g[f];if(e.canPlaySource(h))return{source:h,tech:d}}}return!1};
...
vjs.ControlBar.prototype.createEl=function(){return vjs.createEl("div",{className:"vjs-control-bar"})};vjs.LiveDisplay=vjs.Component.extend({init:function(a,b){vjs.Component.call(this,a,b)}});
...
vjs.CurrentTimeDisplay.prototype.updateContent=function(){var a=this.player_.scrubbing?this.player_.getCache().currentTime:this.player_.currentTime();this.contentEl_.innerHTML='<span class="vjs-control-text">'+this.localize("Current Time")+"</span> "+vjs.formatTime(a,this.player_.duration())};vjs.DurationDisplay=vjs.Component.extend({init:function(a,b){vjs.Component.call(this,a,b);this.on(a,"timeupdate",this.updateContent);this.on(a,"loadedmetadata",this.updateContent)}});
...
b)};vjs.VolumeMenuButton=vjs.MenuButton.extend({init:function(a,b){vjs.MenuButton.call(this,a,b);this.on(a,"volumechange",this.volumeUpdate);a.tech&&!1===a.tech.featuresVolumeControl&&this.addClass("vjs-hidden");this.on(a,"loadstart",function(){!1===a.tech.featuresVolumeControl?this.addClass("vjs-hidden"):this.removeClass("vjs-hidden")});this.addClass("vjs-menu-button")}});
...
vjs.PosterImage.prototype.createEl=function(){var a=vjs.createEl("div",{className:"vjs-poster",tabIndex:-1});vjs.BACKGROUND_SIZE_SUPPORTED||(this.fallbackImg_=vjs.createEl("img"),a.appendChild(this.fallbackImg_));return a};vjs.PosterImage.prototype.update=function(){var a=this.player().poster();this.setSrc(a);a?this.show():this.hide()};vjs.PosterImage.prototype.setSrc=function(a){var b;this.fallbackImg_?this.fallbackImg_.src=a:(b="",a&&(b='url("'+a+'")'),this.el_.style.backgroundImage=b)};
...
(function(){var a;vjs.MediaTechController=vjs.Component.extend({init:function(a,c,d){c=c||{};c.reportTouchActivity=!1;vjs.Component.call(this,a,c,d);this.featuresProgressEvents||this.manualProgressOn();this.featuresTimeupdateEvents||this.manualTimeUpdatesOn();this.initControlsListeners();this.featuresNativeTextTracks||this.emulateTextTracks();this.initTextTrackListeners()}});vjs.MediaTechController.prototype.initControlsListeners=function(){var a,c;a=this.player();c=function(){a.controls()&&!a.usingNativeControls()&&
this.addControlsListeners()};this.ready(c);this.on(a,"controlsenabled",c);this.on(a,"controlsdisabled",this.removeControlsListeners);this.ready(function(){this.networkState&&0<this.networkState()&&this.player().trigger("loadstart")})};vjs.MediaTechController.prototype.addControlsListeners=function(){var a;this.on("mousedown",this.onClick);this.on("touchstart",function(c){a=this.player_.userActive()});this.on("touchmove",function(c){a&&this.player().reportUserActivity()});this.on("touchend",function(a){a.preventDefault()});
...
vjs.MediaTechController.prototype.manualProgressOn=function(){this.manualProgress=!0;this.trackProgress()};vjs.MediaTechController.prototype.manualProgressOff=function(){this.manualProgress=!1;this.stopTrackingProgress()};vjs.MediaTechController.prototype.trackProgress=function(){this.progressInterval=this.setInterval(function(){var a=this.player().bufferedPercent();this.bufferedPercent_!=a&&this.player().trigger("progress");this.bufferedPercent_=a;1===a&&this.stopTrackingProgress()},500)};vjs.MediaTechController.prototype.stopTrackingProgress=
function(){this.clearInterval(this.progressInterval)};vjs.MediaTechController.prototype.manualTimeUpdatesOn=function(){var a=this.player_;this.manualTimeUpdates=!0;this.on(a,"play",this.trackCurrentTime);this.on(a,"pause",this.stopTrackingCurrentTime);this.one("timeupdate",function(){this.featuresTimeupdateEvents=!0;this.manualTimeUpdatesOff()})};vjs.MediaTechController.prototype.manualTimeUpdatesOff=function(){var a=this.player_;this.manualTimeUpdates=!1;this.stopTrackingCurrentTime();this.off(a,
"play",this.trackCurrentTime);this.off(a,"pause",this.stopTrackingCurrentTime)};vjs.MediaTechController.prototype.trackCurrentTime=function(){this.currentTimeInterval&&this.stopTrackingCurrentTime();this.currentTimeInterval=this.setInterval(function(){this.player().trigger("timeupdate")},250)};vjs.MediaTechController.prototype.stopTrackingCurrentTime=function(){this.clearInterval(this.currentTimeInterval);this.player().trigger("timeupdate")};vjs.MediaTechController.prototype.dispose=function(){this.manualProgress&&
this.manualProgressOff();this.manualTimeUpdates&&this.manualTimeUpdatesOff();vjs.Component.prototype.dispose.call(this)};vjs.MediaTechController.prototype.setCurrentTime=function(){this.manualTimeUpdates&&this.player().trigger("timeupdate")};vjs.MediaTechController.prototype.initTextTrackListeners=function(){var a=this.player_,c,d=function(){var c=a.getChild("textTrackDisplay");c&&c.updateDisplay()};if(c=this.textTracks())c.addEventListener("removetrack",d),c.addEventListener("addtrack",d),this.on("dispose",
vjs.bind(this,function(){c.removeEventListener("removetrack",d);c.removeEventListener("addtrack",d)}))};vjs.MediaTechController.prototype.emulateTextTracks=function(){var a=this.player_,c,d,e;window.WebVTT||(e=document.createElement("script"),e.src=a.options()["vtt.js"]||"../node_modules/vtt.js/dist/vtt.js",a.el().appendChild(e),window.WebVTT=!0);if(d=this.textTracks())c=function(){var c,d,e;e=a.getChild("textTrackDisplay");e.updateDisplay();for(c=0;c<this.length;c++)d=this[c],d.removeEventListener("cuechange",
vjs.bind(e,e.updateDisplay)),"showing"===d.mode&&d.addEventListener("cuechange",vjs.bind(e,e.updateDisplay))},d.addEventListener("change",c),this.on("dispose",vjs.bind(this,function(){d.removeEventListener("change",c)}))};vjs.MediaTechController.prototype.textTracks=function(){this.player_.textTracks_=this.player_.textTracks_||new vjs.TextTrackList;return this.player_.textTracks_};vjs.MediaTechController.prototype.remoteTextTracks=function(){this.player_.remoteTextTracks_=this.player_.remoteTextTracks_||
new vjs.TextTrackList;return this.player_.remoteTextTracks_};a=function(a,c,d,e,f){var g=a.textTracks();f=f||{};f.kind=c;d&&(f.label=d);e&&(f.language=e);f.player=a.player_;a=new vjs.TextTrack(f);g.addTrack_(a);return a};vjs.MediaTechController.prototype.addTextTrack=function(b,c,d){if(!b)throw Error("TextTrack kind is required but was not provided");return a(this,b,c,d)};vjs.MediaTechController.prototype.addRemoteTextTrack=function(b){b=a(this,b.kind,b.label,b.language,b);this.remoteTextTracks().addTrack_(b);
return{track:b}};vjs.MediaTechController.prototype.removeRemoteTextTrack=function(a){this.textTracks().removeTrack_(a);this.remoteTextTracks().removeTrack_(a)};vjs.MediaTechController.prototype.setPoster=function(){};vjs.MediaTechController.prototype.featuresVolumeControl=!0;vjs.MediaTechController.prototype.featuresFullscreenResize=!1;vjs.MediaTechController.prototype.featuresPlaybackRate=!1;vjs.MediaTechController.prototype.featuresProgressEvents=!1;vjs.MediaTechController.prototype.featuresTimeupdateEvents=
!1;vjs.MediaTechController.prototype.featuresNativeTextTracks=!1;vjs.MediaTechController.withSourceHandlers=function(a){a.registerSourceHandler=function(c,d){var e=a.sourceHandlers;e||(e=a.sourceHandlers=[]);void 0===d&&(d=e.length);e.splice(d,0,c)};a.selectSourceHandler=function(c){for(var d=a.sourceHandlers||[],e,f=0;f<d.length;f++)if(e=d[f].canHandleSource(c))return d[f];return null};a.canPlaySource=function(c){var d=a.selectSourceHandler(c);return d?d.canHandleSource(c):""};a.prototype.setSource=
function(c){var d=a.selectSourceHandler(c);d||(a.nativeSourceHandler?d=a.nativeSourceHandler:vjs.log.error("No source hander found for the current source."));this.disposeSourceHandler();this.off("dispose",this.disposeSourceHandler);this.currentSource_=c;this.sourceHandler_=d.handleSource(c,this);this.on("dispose",this.disposeSourceHandler);return this};a.prototype.disposeSourceHandler=function(){this.sourceHandler_&&this.sourceHandler_.dispose&&this.sourceHandler_.dispose()}};vjs.media={}})();
vjs.Html5=vjs.MediaTechController.extend({init:function(a,b,c){var d,e,f;if(!1===b.nativeCaptions||!1===b.nativeTextTracks)this.featuresNativeTextTracks=!1;vjs.MediaTechController.call(this,a,b,c);this.setupTriggers();(b=b.source)&&(this.el_.currentSrc!==b.src||a.tag&&3===a.tag.initNetworkState_)&&this.setSource(b);if(this.el_.hasChildNodes()){c=this.el_.childNodes;d=c.length;for(b=[];d--;)e=c[d],f=e.nodeName.toLowerCase(),"track"===f&&(this.featuresNativeTextTracks?this.remoteTextTracks().addTrack_(e.track):
b.push(e));for(c=0;c<b.length;c++)this.el_.removeChild(b[c])}if(this.featuresNativeTextTracks)this.on("loadstart",vjs.bind(this,this.hideCaptions));vjs.TOUCH_ENABLED&&!0===a.options().nativeControlsForTouch&&this.useNativeControls();a.ready(function(){this.src()&&this.tag&&this.options_.autoplay&&this.paused()&&(delete this.tag.poster,this.play())});this.triggerReady()}});vjs.Html5.prototype.dispose=function(){vjs.Html5.disposeMediaElement(this.el_);vjs.MediaTechController.prototype.dispose.call(this)};
vjs.Html5.prototype.createEl=function(){var a=this.player_,b,c,d,e=a.tag;if(!e||!1===this.movingMediaElementInDOM){e?(d=e.cloneNode(!1),vjs.Html5.disposeMediaElement(e),e=d,a.tag=null):(e=vjs.createEl("video"),d=videojs.util.mergeOptions({},a.tagAttributes),vjs.TOUCH_ENABLED&&!0===a.options().nativeControlsForTouch||delete d.controls,vjs.setElementAttributes(e,vjs.obj.merge(d,{id:a.id()+"_html5_api","class":"vjs-tech"})));e.player=a;if(a.options_.tracks)for(d=0;d<a.options_.tracks.length;d++)b=a.options_.tracks[d],
c=document.createElement("track"),c.kind=b.kind,c.label=b.label,c.srclang=b.srclang,c.src=b.src,"default"in b&&c.setAttribute("default","default"),e.appendChild(c);vjs.insertFirst(e,a.el())}b=["autoplay","preload","loop","muted"];for(d=b.length-1;0<=d;d--){c=b[d];var f={};"undefined"!==typeof a.options_[c]&&(f[c]=a.options_[c]);vjs.setElementAttributes(e,f)}return e};
vjs.Html5.prototype.hideCaptions=function(){for(var a=this.el_.querySelectorAll("track"),b,c=a.length,d={captions:1,subtitles:1};c--;)(b=a[c].track)&&b.kind in d&&!a[c]["default"]&&(b.mode="disabled")};vjs.Html5.prototype.setupTriggers=function(){for(var a=vjs.Html5.Events.length-1;0<=a;a--)this.on(vjs.Html5.Events[a],this.eventHandler)};vjs.Html5.prototype.eventHandler=function(a){"error"==a.type&&this.error()?this.player().error(this.error().code):(a.bubbles=!1,this.player().trigger(a))};
...
vjs.Html5.prototype.textTracks=function(){return this.featuresNativeTextTracks?this.el_.textTracks:vjs.MediaTechController.prototype.textTracks.call(this)};vjs.Html5.prototype.addTextTrack=function(a,b,c){return this.featuresNativeTextTracks?this.el_.addTextTrack(a,b,c):vjs.MediaTechController.prototype.addTextTrack.call(this,a,b,c)};
vjs.Html5.prototype.addRemoteTextTrack=function(a){if(!this.featuresNativeTextTracks)return vjs.MediaTechController.prototype.addRemoteTextTrack.call(this,a);var b=document.createElement("track");a=a||{};a.kind&&(b.kind=a.kind);a.label&&(b.label=a.label);if(a.language||a.srclang)b.srclang=a.language||a.srclang;a["default"]&&(b["default"]=a["default"]);a.id&&(b.id=a.id);a.src&&(b.src=a.src);this.el().appendChild(b);b.track.mode="metadata"===b.track.kind?"hidden":"disabled";b.onload=function(){var a=
b.track;2<=b.readyState&&("metadata"===a.kind&&"hidden"!==a.mode?a.mode="hidden":"metadata"!==a.kind&&"disabled"!==a.mode&&(a.mode="disabled"),b.onload=null)};this.remoteTextTracks().addTrack_(b.track);return b};
vjs.Html5.prototype.removeRemoteTextTrack=function(a){if(!this.featuresNativeTextTracks)return vjs.MediaTechController.prototype.removeRemoteTextTrack.call(this,a);var b,c;this.remoteTextTracks().removeTrack_(a);b=this.el().querySelectorAll("track");for(c=0;c<b.length;c++)if(b[c]===a||b[c].track===a){b[c].parentNode.removeChild(b[c]);break}};vjs.Html5.isSupported=function(){try{vjs.TEST_VID.volume=.5}catch(a){return!1}return!!vjs.TEST_VID.canPlayType};vjs.MediaTechController.withSourceHandlers(vjs.Html5);
(function(){var a=vjs.Html5.prototype.setSource,b=vjs.Html5.prototype.disposeSourceHandler;vjs.Html5.prototype.setSource=function(b){var d=a.call(this,b);this.source_=b.src;return d};vjs.Html5.prototype.disposeSourceHandler=function(){this.source_=void 0;return b.call(this)}})();vjs.Html5.nativeSourceHandler={};
vjs.Html5.nativeSourceHandler.canHandleSource=function(a){function b(a){try{return vjs.TEST_VID.canPlayType(a)}catch(b){return""}}return a.type?b(a.type):a.src?(a=(a=a.src.match(/\.([^.\/\?]+)(\?[^\/]+)?$/i))&&a[1],b("video/"+a)):""};vjs.Html5.nativeSourceHandler.handleSource=function(a,b){b.setSrc(a.src)};vjs.Html5.nativeSourceHandler.dispose=function(){};vjs.Html5.registerSourceHandler(vjs.Html5.nativeSourceHandler);
...
vjs.Flash=vjs.MediaTechController.extend({init:function(a,b,c){vjs.MediaTechController.call(this,a,b,c);var d=b.source;c=a.id()+"_flash_api";var e=a.options_,e=vjs.obj.merge({readyFunction:"videojs.Flash.onReady",eventProxyFunction:"videojs.Flash.onEvent",errorEventProxyFunction:"videojs.Flash.onError",autoplay:e.autoplay,preload:e.preload,loop:e.loop,muted:e.muted},b.flashVars),f=vjs.obj.merge({wmode:"opaque",bgcolor:"#000000"},b.params);c=vjs.obj.merge({id:c,name:c,"class":"vjs-tech"},b.attributes);
d&&this.ready(function(){this.setSource(d)});vjs.insertFirst(this.el_,b.parentEl);b.startTime&&this.ready(function(){this.load();this.play();this.currentTime(b.startTime)});vjs.IS_FIREFOX&&this.ready(function(){this.on("mousemove",function(){this.player().trigger({type:"mousemove",bubbles:!1})})});a.on("stageclick",a.reportUserActivity);this.el_=vjs.Flash.embed(b.swf,this.el_,e,f,c)}});vjs.Flash.prototype.dispose=function(){vjs.MediaTechController.prototype.dispose.call(this)};
...
vjs.Flash.embed=function(a,b,c,d,e){a=vjs.Flash.getEmbedCode(a,c,d,e);a=vjs.createEl("div",{innerHTML:a}).childNodes[0];c=b.parentNode;b.parentNode.replaceChild(a,b);a[vjs.expando]=b[vjs.expando];var f=c.childNodes[0];setTimeout(function(){f.style.display="block"},1E3);return a};
...
vjs.MediaLoader=vjs.Component.extend({init:function(a,b,c){vjs.Component.call(this,a,b,c);if(a.options_.sources&&0!==a.options_.sources.length)a.src(a.options_.sources);else for(b=0,c=a.options_.techOrder;b<c.length;b++){var d=vjs.capitalize(c[b]),e=window.videojs[d];if(e&&e.isSupported()){a.loadTech(d);break}}}});vjs.TextTrackMode={disabled:"disabled",hidden:"hidden",showing:"showing"};vjs.TextTrackKind={subtitles:"subtitles",captions:"captions",descriptions:"descriptions",chapters:"chapters",metadata:"metadata"};
(function(){vjs.TextTrack=function(b){var e,f,g,h,k,m,l,p,n,q,r;b=b||{};if(!b.player)throw Error("A player was not provided.");e=this;if(vjs.IS_IE8)for(r in e=document.createElement("custom"),vjs.TextTrack.prototype)e[r]=vjs.TextTrack.prototype[r];e.player_=b.player;g=vjs.TextTrackMode[b.mode]||"disabled";h=vjs.TextTrackKind[b.kind]||"subtitles";k=b.label||"";m=b.language||b.srclang||"";f=b.id||"vjs_text_track_"+vjs.guid++;if("metadata"===h||"chapters"===h)g="hidden";e.cues_=[];e.activeCues_=[];l=
new vjs.TextTrackCueList(e.cues_);p=new vjs.TextTrackCueList(e.activeCues_);q=!1;n=vjs.bind(e,function(){this.activeCues;q&&(this.trigger("cuechange"),q=!1)});if("disabled"!==g)e.player_.on("timeupdate",n);Object.defineProperty(e,"kind",{get:function(){return h},set:Function.prototype});Object.defineProperty(e,"label",{get:function(){return k},set:Function.prototype});Object.defineProperty(e,"language",{get:function(){return m},set:Function.prototype});Object.defineProperty(e,"id",{get:function(){return f},
set:Function.prototype});Object.defineProperty(e,"mode",{get:function(){return g},set:function(a){if(vjs.TextTrackMode[a]){g=a;if("showing"===g)this.player_.on("timeupdate",n);this.trigger("modechange")}}});Object.defineProperty(e,"cues",{get:function(){return this.loaded_?l:null},set:Function.prototype});Object.defineProperty(e,"activeCues",{get:function(){var a,b,d,e,f;if(!this.loaded_)return null;if(0===this.cues.length)return p;e=this.player_.currentTime();a=0;b=this.cues.length;for(d=[];a<b;a++)f=
this.cues[a],f.startTime<=e&&f.endTime>=e?d.push(f):f.startTime===f.endTime&&f.startTime<=e&&f.startTime+.5>=e&&d.push(f);q=!1;if(d.length!==this.activeCues_.length)q=!0;else for(a=0;a<d.length;a++)-1===c.call(this.activeCues_,d[a])&&(q=!0);this.activeCues_=d;p.setCues_(this.activeCues_);return p},set:Function.prototype});b.src?a(b.src,e):e.loaded_=!0;if(vjs.IS_IE8)return e};vjs.TextTrack.prototype=vjs.obj.create(vjs.EventEmitter.prototype);vjs.TextTrack.prototype.constructor=vjs.TextTrack;vjs.TextTrack.prototype.allowedEvents_=
{cuechange:"cuechange"};vjs.TextTrack.prototype.addCue=function(a){var b=this.player_.textTracks(),c=0;if(b)for(;c<b.length;c++)b[c]!==this&&b[c].removeCue(a);this.cues_.push(a);this.cues.setCues_(this.cues_)};vjs.TextTrack.prototype.removeCue=function(a){for(var b=0,c=this.cues_.length,g,h=!1;b<c;b++)g=this.cues_[b],g===a&&(this.cues_.splice(b,1),h=!0);h&&this.cues.setCues_(this.cues_)};var a,b,c;a=function(a,c){vjs.xhr(a,vjs.bind(this,function(a,d,h){if(a)return vjs.log.error(a);c.loaded_=!0;b(h,
c)}))};b=function(a,c){if("function"!==typeof window.WebVTT)return window.setTimeout(function(){b(a,c)},25);var f=new window.WebVTT.Parser(window,window.vttjs,window.WebVTT.StringDecoder());f.oncue=function(a){c.addCue(a)};f.onparsingerror=function(a){vjs.log.error(a)};f.parse(a);f.flush()};c=function(a,b){var c;if(null==this)throw new TypeError('"this" is null or not defined');var g=Object(this),h=g.length>>>0;if(0===h)return-1;c=+b||0;Infinity===Math.abs(c)&&(c=0);if(c>=h)return-1;for(c=Math.max(0<=
c?c:h-Math.abs(c),0);c<h;){if(c in g&&g[c]===a)return c;c++}return-1}})();vjs.TextTrackList=function(a){var b=this,c,d=0;if(vjs.IS_IE8)for(c in b=document.createElement("custom"),vjs.TextTrackList.prototype)b[c]=vjs.TextTrackList.prototype[c];a=a||[];b.tracks_=[];for(Object.defineProperty(b,"length",{get:function(){return this.tracks_.length}});d<a.length;d++)b.addTrack_(a[d]);if(vjs.IS_IE8)return b};vjs.TextTrackList.prototype=vjs.obj.create(vjs.EventEmitter.prototype);
...
vjs.TextTrackList.prototype.addTrack_=function(a){var b=this.tracks_.length;""+b in this||Object.defineProperty(this,b,{get:function(){return this.tracks_[b]}});a.addEventListener("modechange",vjs.bind(this,function(){this.trigger("change")}));this.tracks_.push(a);this.trigger({type:"addtrack",track:a})};vjs.TextTrackList.prototype.removeTrack_=function(a){for(var b=0,c=this.length,d;b<c;b++)if(d=this[b],d===a){this.tracks_.splice(b,1);break}this.trigger({type:"removetrack",track:a})};
vjs.TextTrackList.prototype.getTrackById=function(a){for(var b=0,c=this.length,d=null,e;b<c;b++)if(e=this[b],e.id===a){d=e;break}return d};vjs.TextTrackCueList=function(a){var b=this,c;if(vjs.IS_IE8)for(c in b=document.createElement("custom"),vjs.TextTrackCueList.prototype)b[c]=vjs.TextTrackCueList.prototype[c];vjs.TextTrackCueList.prototype.setCues_.call(b,a);Object.defineProperty(b,"length",{get:function(){return this.length_}});if(vjs.IS_IE8)return b};
vjs.TextTrackCueList.prototype.setCues_=function(a){var b=this.length||0,c=0,d=a.length;this.cues_=a;this.length_=a.length;a=function(a){""+a in this||Object.defineProperty(this,""+a,{get:function(){return this.cues_[a]}})};if(b<d)for(c=b;c<d;c++)a.call(this,c)};vjs.TextTrackCueList.prototype.getCueById=function(a){for(var b=0,c=this.length,d=null,e;b<c;b++)if(e=this[b],e.id===a){d=e;break}return d};
(function(){vjs.TextTrackDisplay=vjs.Component.extend({init:function(a,b,e){vjs.Component.call(this,a,b,e);a.on("loadstart",vjs.bind(this,this.toggleDisplay));a.ready(vjs.bind(this,function(){if(a.tech&&a.tech.featuresNativeTextTracks)this.hide();else{var b,d,e;a.on("fullscreenchange",vjs.bind(this,this.updateDisplay));d=a.options_.tracks||[];for(b=0;b<d.length;b++)e=d[b],this.player_.addRemoteTextTrack(e)}}))}});vjs.TextTrackDisplay.prototype.toggleDisplay=function(){this.player_.tech&&this.player_.tech.featuresNativeTextTracks?
this.hide():this.show()};vjs.TextTrackDisplay.prototype.createEl=function(){return vjs.Component.prototype.createEl.call(this,"div",{className:"vjs-text-track-display"})};vjs.TextTrackDisplay.prototype.clearDisplay=function(){"function"===typeof window.WebVTT&&window.WebVTT.processCues(window,[],this.el_)};var a=function(a,b){return"rgba("+parseInt(a[1]+a[1],16)+","+parseInt(a[2]+a[2],16)+","+parseInt(a[3]+a[3],16)+","+b+")"},b={monospace:"monospace",sansSerif:"sans-serif",serif:"serif",monospaceSansSerif:'"Andale Mono", "Lucida Console", monospace',
monospaceSerif:'"Courier New", monospace',proportionalSansSerif:"sans-serif",proportionalSerif:"serif",casual:'"Comic Sans MS", Impact, fantasy',script:'"Monotype Corsiva", cursive',smallcaps:'"Andale Mono", "Lucida Console", monospace, sans-serif'};vjs.TextTrackDisplay.prototype.updateDisplay=function(){var a=this.player_.textTracks(),b=0,e;this.clearDisplay();if(a)for(;b<a.length;b++)e=a[b],"showing"===e.mode&&this.updateForTrack(e)};vjs.TextTrackDisplay.prototype.updateForTrack=function(c){if("function"===
typeof window.WebVTT&&c.activeCues){for(var d=0,e=this.player_.textTrackSettings.getValues(),f,g=[];d<c.activeCues.length;d++)g.push(c.activeCues[d]);window.WebVTT.processCues(window,c.activeCues,this.el_);for(d=g.length;d--;){c=g[d].displayState;e.color&&(c.firstChild.style.color=e.color);if(e.textOpacity){f=a(e.color||"#fff",e.textOpacity);try{c.firstChild.style.color=f}catch(h){}}e.backgroundColor&&(c.firstChild.style.backgroundColor=e.backgroundColor);if(e.backgroundOpacity){f=a(e.backgroundColor||
"#000",e.backgroundOpacity);try{c.firstChild.style.backgroundColor=f}catch(h){}}if(e.windowColor)if(e.windowOpacity){f=a(e.windowColor,e.windowOpacity);try{c.style.backgroundColor=f}catch(h){}}else c.style.backgroundColor=e.windowColor;e.edgeStyle&&("dropshadow"===e.edgeStyle?c.firstChild.style.textShadow="2px 2px 3px #222, 2px 2px 4px #222, 2px 2px 5px #222":"raised"===e.edgeStyle?c.firstChild.style.textShadow="1px 1px #222, 2px 2px #222, 3px 3px #222":"depressed"===e.edgeStyle?c.firstChild.style.textShadow=
"1px 1px #ccc, 0 1px #ccc, -1px -1px #222, 0 -1px #222":"uniform"===e.edgeStyle&&(c.firstChild.style.textShadow="0 0 4px #222, 0 0 4px #222, 0 0 4px #222, 0 0 4px #222"));e.fontPercent&&1!==e.fontPercent&&(f=window.parseFloat(c.style.fontSize),c.style.fontSize=f*e.fontPercent+"px",c.style.height="auto",c.style.top="auto",c.style.bottom="2px");e.fontFamily&&"default"!==e.fontFamily&&("small-caps"===e.fontFamily?c.firstChild.style.fontVariant="small-caps":c.firstChild.style.fontFamily=b[e.fontFamily])}}};
vjs.TextTrackMenuItem=vjs.MenuItem.extend({init:function(a,b){var e=this.track=b.track,f=a.textTracks(),g,h;f&&(g=vjs.bind(this,function(){var a="showing"===this.track.mode,b,c,d;if(this instanceof vjs.OffTextTrackMenuItem)for(a=!0,c=0,d=f.length;c<d;c++)if(b=f[c],b.kind===this.track.kind&&"showing"===b.mode){a=!1;break}this.selected(a)}),f.addEventListener("change",g),a.on("dispose",function(){f.removeEventListener("change",g)}));b.label=e.label||e.language||"Unknown";b.selected=e["default"]||"showing"===
e.mode;vjs.MenuItem.call(this,a,b);if(f&&void 0===f.onchange)this.on(["tap","click"],function(){if("object"!==typeof window.Event)try{h=new window.Event("change")}catch(a){}h||(h=document.createEvent("Event"),h.initEvent("change",!0,!0));f.dispatchEvent(h)})}});vjs.TextTrackMenuItem.prototype.onClick=function(){var a=this.track.kind,b=this.player_.textTracks(),e,f=0;vjs.MenuItem.prototype.onClick.call(this);if(b)for(;f<b.length;f++)e=b[f],e.kind===a&&(e.mode=e===this.track?"showing":"disabled")};
...
vjs.TextTrackButton=vjs.MenuButton.extend({init:function(a,b){var e,f;vjs.MenuButton.call(this,a,b);e=this.player_.textTracks();1>=this.items.length&&this.hide();e&&(f=vjs.bind(this,this.update),e.addEventListener("removetrack",f),e.addEventListener("addtrack",f),this.player_.on("dispose",function(){e.removeEventListener("removetrack",f);e.removeEventListener("addtrack",f)}))}});vjs.TextTrackButton.prototype.createItems=function(){var a=[],b,e;!(this instanceof vjs.CaptionsButton)||this.player().tech&&
this.player().tech.featuresNativeTextTracks||a.push(new vjs.CaptionSettingsMenuItem(this.player_,{kind:this.kind_}));a.push(new vjs.OffTextTrackMenuItem(this.player_,{kind:this.kind_}));e=this.player_.textTracks();if(!e)return a;for(var f=0;f<e.length;f++)b=e[f],b.kind===this.kind_&&a.push(new vjs.TextTrackMenuItem(this.player_,{track:b}));return a};vjs.CaptionsButton=vjs.TextTrackButton.extend({init:function(a,b,e){vjs.TextTrackButton.call(this,a,b,e);this.el_.setAttribute("aria-label","Captions Menu")}});
vjs.CaptionsButton.prototype.kind_="captions";vjs.CaptionsButton.prototype.buttonText="Captions";vjs.CaptionsButton.prototype.className="vjs-captions-button";vjs.CaptionsButton.prototype.update=function(){var a=2;vjs.TextTrackButton.prototype.update.call(this);this.player().tech&&this.player().tech.featuresNativeTextTracks&&(a=1);this.items&&this.items.length>a?this.show():this.hide()};vjs.SubtitlesButton=vjs.TextTrackButton.extend({init:function(a,b,e){vjs.TextTrackButton.call(this,a,b,e);this.el_.setAttribute("aria-label",
"Subtitles Menu")}});vjs.SubtitlesButton.prototype.kind_="subtitles";vjs.SubtitlesButton.prototype.buttonText="Subtitles";vjs.SubtitlesButton.prototype.className="vjs-subtitles-button";vjs.ChaptersButton=vjs.TextTrackButton.extend({init:function(a,b,e){vjs.TextTrackButton.call(this,a,b,e);this.el_.setAttribute("aria-label","Chapters Menu")}});vjs.ChaptersButton.prototype.kind_="chapters";vjs.ChaptersButton.prototype.buttonText="Chapters";vjs.ChaptersButton.prototype.className="vjs-chapters-button";
vjs.ChaptersButton.prototype.createItems=function(){var a=[],b,e;e=this.player_.textTracks();if(!e)return a;for(var f=0;f<e.length;f++)b=e[f],b.kind===this.kind_&&a.push(new vjs.TextTrackMenuItem(this.player_,{track:b}));return a};vjs.ChaptersButton.prototype.createMenu=function(){for(var a=this.player_.textTracks()||[],b=0,e=a.length,f,g,h=this.items=[];b<e;b++)if(f=a[b],f.kind==this.kind_)if(f.cues){g=f;break}else f.mode="hidden",window.setTimeout(vjs.bind(this,function(){this.createMenu()}),100);
a=this.menu;void 0===a&&(a=new vjs.Menu(this.player_),a.contentEl().appendChild(vjs.createEl("li",{className:"vjs-menu-title",innerHTML:vjs.capitalize(this.kind_),tabindex:-1})));if(g){f=g.cues;for(var k,b=0,e=f.length;b<e;b++)k=f[b],k=new vjs.ChaptersTrackMenuItem(this.player_,{track:g,cue:k}),h.push(k),a.addChild(k);this.addChild(a)}0<this.items.length&&this.show();return a};vjs.ChaptersTrackMenuItem=vjs.MenuItem.extend({init:function(a,b){var e=this.track=b.track,f=this.cue=b.cue,g=a.currentTime();
b.label=f.text;b.selected=f.startTime<=g&&g<f.endTime;vjs.MenuItem.call(this,a,b);e.addEventListener("cuechange",vjs.bind(this,this.update))}});vjs.ChaptersTrackMenuItem.prototype.onClick=function(){vjs.MenuItem.prototype.onClick.call(this);this.player_.currentTime(this.cue.startTime);this.update(this.cue.startTime)};vjs.ChaptersTrackMenuItem.prototype.update=function(){var a=this.cue,b=this.player_.currentTime();this.selected(a.startTime<=b&&b<a.endTime)}})();
(function(){function a(a){var b;a.selectedOptions?b=a.selectedOptions[0]:a.options&&(b=a.options[a.options.selectedIndex]);return b.value}function b(a,b){var e,f;if(b){for(e=0;e<a.options.length&&(f=a.options[e],f.value!==b);e++);a.selectedIndex=e}}vjs.TextTrackSettings=vjs.Component.extend({init:function(a,b){vjs.Component.call(this,a,b);this.hide();vjs.on(this.el().querySelector(".vjs-done-button"),"click",vjs.bind(this,function(){this.saveSettings();this.hide()}));vjs.on(this.el().querySelector(".vjs-default-button"),
...
vjs.TextTrackSettings.prototype.getValues=function(){var b,d,e,f,g,h,k,m,l,p;b=this.el();g=a(b.querySelector(".vjs-edge-style select"));h=a(b.querySelector(".vjs-font-family select"));k=a(b.querySelector(".vjs-fg-color > select"));e=a(b.querySelector(".vjs-text-opacity > select"));m=a(b.querySelector(".vjs-bg-color > select"));d=a(b.querySelector(".vjs-bg-opacity > select"));l=a(b.querySelector(".window-color > select"));f=a(b.querySelector(".vjs-window-opacity > select"));b=window.parseFloat(a(b.querySelector(".vjs-font-percent > select")));
d={backgroundOpacity:d,textOpacity:e,windowOpacity:f,edgeStyle:g,fontFamily:h,color:k,backgroundColor:m,windowColor:l,fontPercent:b};for(p in d)(""===d[p]||"none"===d[p]||"fontPercent"===p&&1===d[p])&&delete d[p];return d};vjs.TextTrackSettings.prototype.setValues=function(a){var d=this.el();b(d.querySelector(".vjs-edge-style select"),a.edgeStyle);b(d.querySelector(".vjs-font-family select"),a.fontFamily);b(d.querySelector(".vjs-fg-color > select"),a.color);b(d.querySelector(".vjs-text-opacity > select"),
a.textOpacity);b(d.querySelector(".vjs-bg-color > select"),a.backgroundColor);b(d.querySelector(".vjs-bg-opacity > select"),a.backgroundOpacity);b(d.querySelector(".window-color > select"),a.windowColor);b(d.querySelector(".vjs-window-opacity > select"),a.windowOpacity);(a=a.fontPercent)&&(a=a.toFixed(2));b(d.querySelector(".vjs-font-percent > select"),a)};vjs.TextTrackSettings.prototype.restoreSettings=function(){var a;try{a=JSON.parse(window.localStorage.getItem("vjs-text-track-settings"))}catch(b){}a&&
...
if("undefined"!==typeof window.JSON&&"function"===typeof window.JSON.parse)vjs.JSON=window.JSON;else{vjs.JSON={};var cx=/[\u0000\u00ad\u0600-\u0604\u070f\u17b4\u17b5\u200c-\u200f\u2028-\u202f\u2060-\u206f\ufeff\ufff0-\uffff]/g;vjs.JSON.parse=function(a,b){function c(a,d){var g,h,k=a[d];if(k&&"object"===typeof k)for(g in k)Object.prototype.hasOwnProperty.call(k,g)&&(h=c(k,g),void 0!==h?k[g]=h:delete k[g]);return b.call(a,d,k)}var d;a=String(a);cx.lastIndex=0;cx.test(a)&&(a=a.replace(cx,function(a){return"\\u"+
...
vjs.autoSetupTimeout=function(a){setTimeout(vjs.autoSetup,a)};if("complete"===document.readyState)vjs.windowLoaded=!0;else vjs.one(window,"load",function(){vjs.windowLoaded=!0});vjs.autoSetupTimeout(1);vjs.plugin=function(a,b){vjs.Player.prototype[a]=b};(function(a){var b=a.vttjs={},c=b.VTTCue,d=b.VTTRegion,e=a.VTTCue,f=a.VTTRegion;b.shim=function(){b.VTTCue=c;b.VTTRegion=d};b.restore=function(){b.VTTCue=e;b.VTTRegion=f}})(this);
(function(a,b){function c(a){return"string"!==typeof a?!1:g[a.toLowerCase()]?a.toLowerCase():!1}function d(a){for(var b=1;b<arguments.length;b++){var c=arguments[b],d;for(d in c)a[d]=c[d]}return a}function e(a,b,e){var g=this,p=/MSIE\s8\.0/.test(navigator.userAgent),n={};p?g=document.createElement("custom"):n.enumerable=!0;g.hasBeenReset=!1;var q="",r=!1,x=a,y=b,D=e,E=null,F="",H=!0,C="auto",z="start",G=50,I="middle",J=50,K="middle";Object.defineProperty(g,"id",d({},n,{get:function(){return q},set:function(a){q=
""+a}}));Object.defineProperty(g,"pauseOnExit",d({},n,{get:function(){return r},set:function(a){r=!!a}}));Object.defineProperty(g,"startTime",d({},n,{get:function(){return x},set:function(a){if("number"!==typeof a)throw new TypeError("Start time must be set to a number.");x=a;this.hasBeenReset=!0}}));Object.defineProperty(g,"endTime",d({},n,{get:function(){return y},set:function(a){if("number"!==typeof a)throw new TypeError("End time must be set to a number.");y=a;this.hasBeenReset=!0}}));Object.defineProperty(g,
"text",d({},n,{get:function(){return D},set:function(a){D=""+a;this.hasBeenReset=!0}}));Object.defineProperty(g,"region",d({},n,{get:function(){return E},set:function(a){E=a;this.hasBeenReset=!0}}));Object.defineProperty(g,"vertical",d({},n,{get:function(){return F},set:function(a){a="string"!==typeof a?!1:f[a.toLowerCase()]?a.toLowerCase():!1;if(!1===a)throw new SyntaxError("An invalid or illegal string was specified.");F=a;this.hasBeenReset=!0}}));Object.defineProperty(g,"snapToLines",d({},n,{get:function(){return H},
set:function(a){H=!!a;this.hasBeenReset=!0}}));Object.defineProperty(g,"line",d({},n,{get:function(){return C},set:function(a){if("number"!==typeof a&&"auto"!==a)throw new SyntaxError("An invalid number or illegal string was specified.");C=a;this.hasBeenReset=!0}}));Object.defineProperty(g,"lineAlign",d({},n,{get:function(){return z},set:function(a){a=c(a);if(!a)throw new SyntaxError("An invalid or illegal string was specified.");z=a;this.hasBeenReset=!0}}));Object.defineProperty(g,"position",d({},
n,{get:function(){return G},set:function(a){if(0>a||100<a)throw Error("Position must be between 0 and 100.");G=a;this.hasBeenReset=!0}}));Object.defineProperty(g,"positionAlign",d({},n,{get:function(){return I},set:function(a){a=c(a);if(!a)throw new SyntaxError("An invalid or illegal string was specified.");I=a;this.hasBeenReset=!0}}));Object.defineProperty(g,"size",d({},n,{get:function(){return J},set:function(a){if(0>a||100<a)throw Error("Size must be between 0 and 100.");J=a;this.hasBeenReset=
!0}}));Object.defineProperty(g,"align",d({},n,{get:function(){return K},set:function(a){a=c(a);if(!a)throw new SyntaxError("An invalid or illegal string was specified.");K=a;this.hasBeenReset=!0}}));g.displayState=void 0;if(p)return g}var f={"":!0,lr:!0,rl:!0},g={start:!0,middle:!0,end:!0,left:!0,right:!0};e.prototype.getCueAsHTML=function(){return WebVTT.convertCueToDOMTree(window,this.text)};a.VTTCue=a.VTTCue||e;b.VTTCue=e})(this,this.vttjs||{});
(function(a,b){function c(a){return"number"===typeof a&&0<=a&&100>=a}function d(){var a=100,b=3,d=0,k=100,m=0,l=100,p="";Object.defineProperties(this,{width:{enumerable:!0,get:function(){return a},set:function(b){if(!c(b))throw Error("Width must be between 0 and 100.");a=b}},lines:{enumerable:!0,get:function(){return b},set:function(a){if("number"!==typeof a)throw new TypeError("Lines must be set to a number.");b=a}},regionAnchorY:{enumerable:!0,get:function(){return k},set:function(a){if(!c(a))throw Error("RegionAnchorX must be between 0 and 100.");
k=a}},regionAnchorX:{enumerable:!0,get:function(){return d},set:function(a){if(!c(a))throw Error("RegionAnchorY must be between 0 and 100.");d=a}},viewportAnchorY:{enumerable:!0,get:function(){return l},set:function(a){if(!c(a))throw Error("ViewportAnchorY must be between 0 and 100.");l=a}},viewportAnchorX:{enumerable:!0,get:function(){return m},set:function(a){if(!c(a))throw Error("ViewportAnchorX must be between 0 and 100.");m=a}},scroll:{enumerable:!0,get:function(){return p},set:function(a){a=
"string"!==typeof a?!1:e[a.toLowerCase()]?a.toLowerCase():!1;if(!1===a)throw new SyntaxError("An invalid or illegal string was specified.");p=a}}})}var e={"":!0,up:!0};a.VTTRegion=a.VTTRegion||d;b.VTTRegion=d})(this,this.vttjs||{});
(function(a){function b(a,b){this.name="ParsingError";this.code=a.code;this.message=b||a.message}function c(a){a=a.match(/^(\d+):(\d{2})(:\d{2})?\.(\d{3})/);if(!a)return null;if(a[3]){var b=a[3].replace(":","");return 3600*(a[1]|0)+60*(a[2]|0)+(b|0)+(a[4]|0)/1E3}return 59<a[1]?3600*(a[1]|0)+60*(a[2]|0)+0+(a[4]|0)/1E3:0+60*(a[1]|0)+(a[2]|0)+(a[4]|0)/1E3}function d(){this.values=n(null)}function e(a,b,c,d){a=d?a.split(d):[a];for(var e in a)"string"===typeof a[e]&&(d=a[e].split(c),2===d.length&&b(d[0],
d[1]))}function f(a,f,g){function l(){var d=c(a);if(null===d)throw new b(b.Errors.BadTimeStamp,"Malformed timestamp: "+h);a=a.replace(/^[^\sa-zA-Z-]+/,"");return d}function z(){a=a.replace(/^\s+/,"")}var h=a;z();f.startTime=l();z();if("--\x3e"!==a.substr(0,3))throw new b(b.Errors.BadTimeStamp,"Malformed time stamp (time stamps must be separated by '--\x3e'): "+h);a=a.substr(3);z();f.endTime=l();z();(function(a,b){var c=new d;e(a,function(a,b){switch(a){case "region":for(var d=g.length-1;0<=d;d--)if(g[d].id===
b){c.set(a,g[d].region);break}break;case "vertical":c.alt(a,b,["rl","lr"]);break;case "line":var d=b.split(","),e=d[0];c.integer(a,e);c.percent(a,e)?c.set("snapToLines",!1):null;c.alt(a,e,["auto"]);2===d.length&&c.alt("lineAlign",d[1],["start","middle","end"]);break;case "position":d=b.split(",");c.percent(a,d[0]);2===d.length&&c.alt("positionAlign",d[1],["start","middle","end"]);break;case "size":c.percent(a,b);break;case "align":c.alt(a,b,["start","middle","end","left","right"])}},/:/,/\s/);b.region=
c.get("region",null);b.vertical=c.get("vertical","");b.line=c.get("line","auto");b.lineAlign=c.get("lineAlign","start");b.snapToLines=c.get("snapToLines",!0);b.size=c.get("size",100);b.align=c.get("align","middle");b.position=c.get("position",{start:0,left:0,middle:50,end:100,right:100},b.align);b.positionAlign=c.get("positionAlign",{start:"start",left:"start",middle:"middle",end:"end",right:"end"},b.align)})(a,f)}function g(a,b){function d(){if(!b)return null;var a=b.match(/^([^<]*)(<[^>]+>?)?/),
a=a[1]?a[1]:a[2];b=b.substr(a.length);return a}function e(a){return q[a]}function f(a){for(;n=a.match(/&(amp|lt|gt|lrm|rlm|nbsp);/);)a=a.replace(n[0],e);return a}function g(b,c){var d=r[b];if(!d)return null;var e=a.document.createElement(d);e.localName=d;(d=x[b])&&c&&(e[d]=c.trim());return e}for(var l=a.document.createElement("div"),h=l,k,m=[];null!==(k=d());)if("<"===k[0])if("/"===k[1])m.length&&m[m.length-1]===k.substr(2).replace(">","")&&(m.pop(),h=h.parentNode);else{var p=c(k.substr(1,k.length-
2));if(p)k=a.document.createProcessingInstruction("timestamp",p),h.appendChild(k);else{var n=k.match(/^<([^.\s/0-9>]+)(\.[^\s\\>]+)?([^>\\]+)?(\\?)>?$/);n&&(!(k=g(n[1],n[3]))||y[k.localName]&&y[k.localName]!==h.localName||(n[2]&&(k.className=n[2].substr(1).replace("."," ")),m.push(n[1]),h.appendChild(k),h=k))}}else h.appendChild(a.document.createTextNode(f(k)));return l}function h(a){function b(a,c){for(var d=c.childNodes.length-1;0<=d;d--)a.push(c.childNodes[d])}function c(a){if(!a||!a.length)return null;
var d=a.pop(),e=d.textContent||d.innerText;if(e)return(d=e.match(/^.*(\n|\r)/))?(a.length=0,d[0]):e;if("ruby"===d.tagName)return c(a);if(d.childNodes)return b(a,d),c(a)}var d=[],e="";if(!a||!a.childNodes)return"ltr";for(b(d,a);e=c(d);)for(var f=0;f<e.length;f++){a=e.charCodeAt(f);for(var g=0;g<D.length;g++)if(D[g]===a)return"rtl"}return"ltr"}function k(){}function m(a,b,c){var d=/MSIE\s8\.0/.test(navigator.userAgent),e="rgba(255, 255, 255, 1)",f="rgba(0, 0, 0, 0.8)";d&&(e="rgb(255, 255, 255)",f="rgb(0, 0, 0)");
this.cue=b;this.cueDiv=g(a,b.text);e={color:e,backgroundColor:f,position:"relative",left:0,right:0,top:0,bottom:0,display:"inline"};d||(e.writingMode=""===b.vertical?"horizontal-tb":"lr"===b.vertical?"vertical-lr":"vertical-rl",e.unicodeBidi="plaintext");this.applyStyles(e,this.cueDiv);this.div=a.document.createElement("div");e={textAlign:"middle"===b.align?"center":b.align,font:c.font,whiteSpace:"pre-line",position:"absolute"};d||(e.direction=h(this.cueDiv),e.writingMode=""===b.vertical?"horizontal-tb":
"lr"===b.vertical?"vertical-lr":"vertical-rl".stylesunicodeBidi="plaintext");this.applyStyles(e);this.div.appendChild(this.cueDiv);a=0;switch(b.positionAlign){case "start":a=b.position;break;case "middle":a=b.position-b.size/2;break;case "end":a=b.position-b.size}""===b.vertical?this.applyStyles({left:this.formatStyle(a,"%"),width:this.formatStyle(b.size,"%")}):this.applyStyles({top:this.formatStyle(a,"%"),height:this.formatStyle(b.size,"%")});this.move=function(a){this.applyStyles({top:this.formatStyle(a.top,
...
a.left;this.right=a.right;this.top=a.top||f;this.height=a.height||d;this.bottom=a.bottom||f+(a.height||d);this.width=a.width||e;this.lineHeight=void 0!==c?c:a.lineHeight;b&&!this.lineHeight&&(this.lineHeight=13)}function p(){}var n=Object.create||function(){function a(){}return function(b){if(1!==arguments.length)throw Error("Object.create shim only accepts one parameter.");a.prototype=b;return new a}}();b.prototype=n(Error.prototype);b.prototype.constructor=b;b.Errors={BadSignature:{code:0,message:"Malformed WebVTT signature."},
...
b)?(this.set(a,b),!0):!1}};var q={"&amp;":"&","&lt;":"<","&gt;":">","&lrm;":"\u200e","&rlm;":"\u200f","&nbsp;":"\u00a0"},r={c:"span",i:"i",b:"b",u:"u",ruby:"ruby",rt:"rt",v:"span",lang:"span"},x={v:"title",lang:"lang"},y={rt:"ruby"},D=[1470,1472,1475,1478,1488,1489,1490,1491,1492,1493,1494,1495,1496,1497,1498,1499,1500,1501,1502,1503,1504,1505,1506,1507,1508,1509,1510,1511,1512,1513,1514,1520,1521,1522,1523,1524,1544,1547,1549,1563,1566,1567,1568,1569,1570,1571,1572,1573,1574,1575,1576,1577,1578,
...
function(a,b,c){if(!a||!b||!c)return null;for(;c.firstChild;)c.removeChild(c.firstChild);var d=a.document.createElement("div");d.style.position="absolute";d.style.left="0";d.style.right="0";d.style.top="0";d.style.bottom="0";d.style.margin="1.5%";c.appendChild(d);if(function(a){for(var b=0;b<a.length;b++)if(a[b].hasBeenReset||!a[b].displayState)return!0;return!1}(b)){var e=[],f=l.getSimpleBoxPosition(d),g={font:Math.round(5*f.height)/100+"px sans-serif"};(function(){for(var c,k,h=0;h<b.length;h++){k=
b[h];c=new m(a,k,g);d.appendChild(c.div);var n=c,p=f,r=e,q=new l(n),t=n.cue,u;if("number"===typeof t.line&&(t.snapToLines||0<=t.line&&100>=t.line))u=t.line;else if(t.track&&t.track.textTrackList&&t.track.textTrackList.mediaElement){var w=t.track;u=w.textTrackList;for(var A=0,v=0;v<u.length&&u[v]!==w;v++)"showing"===u[v].mode&&A++;u=-1*++A}else u=-1;w=[];if(t.snapToLines){var B=void 0;switch(t.vertical){case "":w=["+y","-y"];B="height";break;case "rl":w=["+x","-x"];B="width";break;case "lr":w=["-x",
"+x"],B="width"}var A=q.lineHeight,v=A*Math.round(u),B=p[B]+A,Q=w[0];Math.abs(v)>B&&(v=0>v?-1:1,v=v*Math.ceil(B/A)*A);0>u&&(v+=""===t.vertical?p.height:p.width,w=w.reverse());q.move(Q,v)}else{q=q.lineHeight/p.height*100;switch(t.lineAlign){case "middle":u-=q/2;break;case "end":u-=q}switch(t.vertical){case "":n.applyStyles({top:n.formatStyle(u,"%")});break;case "rl":n.applyStyles({left:n.formatStyle(u,"%")});break;case "lr":n.applyStyles({right:n.formatStyle(u,"%")})}w=["+y","-x","+x","-y"];q=new l(n)}t=
void 0;a:{t=w;w=void 0;u=new l(q);A=1;for(v=0;v<t.length;v++){for(;q.overlapsOppositeAxis(p,t[v])||q.within(p)&&q.overlapsAny(r);)q.move(t[v]);if(q.within(p)){t=q;break a}B=q.intersectPercentage(p);A>B&&(w=new l(q),A=B);q=new l(u)}t=w||u}n.move(t.toCSSCompatValues(p));k.displayState=c.div;e.push(l.getSimpleBoxPosition(c))}})()}else for(c=0;c<b.length;c++)d.appendChild(b[c].displayState)};p.Parser=function(a,b,c){c||(c=b,b={});b||(b={});this.window=a;this.vttjs=b;this.state="INITIAL";this.buffer="";
this.decoder=c||new TextDecoder("utf8");this.regionList=[]};p.Parser.prototype={reportOrThrowError:function(a){if(a instanceof b)this.onparsingerror&&this.onparsingerror(a);else throw a;},parse:function(a){function c(){for(var a=h.buffer,b=0;b<a.length&&"\r"!==a[b]&&"\n"!==a[b];)++b;var d=a.substr(0,b);"\r"===a[b]&&++b;"\n"===a[b]&&++b;h.buffer=a.substr(b);return d}function g(a){var b=new d;e(a,function(a,c){switch(a){case "id":b.set(a,c);break;case "width":b.percent(a,c);break;case "lines":b.integer(a,
c);break;case "regionanchor":case "viewportanchor":var e=c.split(",");if(2!==e.length)break;var f=new d;f.percent("x",e[0]);f.percent("y",e[1]);if(!f.has("x")||!f.has("y"))break;b.set(a+"X",f.get("x"));b.set(a+"Y",f.get("y"));break;case "scroll":b.alt(a,c,["up"])}},/=/,/\s/);b.has("id")&&(a=new (h.vttjs.VTTRegion||h.window.VTTRegion),a.width=b.get("width",100),a.lines=b.get("lines",3),a.regionAnchorX=b.get("regionanchorX",0),a.regionAnchorY=b.get("regionanchorY",100),a.viewportAnchorX=b.get("viewportanchorX",
0),a.viewportAnchorY=b.get("viewportanchorY",100),a.scroll=b.get("scroll",""),h.onregion&&h.onregion(a),h.regionList.push({id:b.get("id"),region:a}))}function k(a){e(a,function(a,b){switch(a){case "Region":g(b)}},/:/)}var h=this;a&&(h.buffer+=h.decoder.decode(a,{stream:!0}));try{var l;if("INITIAL"===h.state){if(!/\r\n|\n/.test(h.buffer))return this;l=c();var m=l.match(/^WEBVTT([ \t].*)?$/);if(!m||!m[0])throw new b(b.Errors.BadSignature);h.state="HEADER"}for(a=!1;h.buffer;){if(!/\r\n|\n/.test(h.buffer))return this;
a?a=!1:l=c();switch(h.state){case "HEADER":/:/.test(l)?k(l):l||(h.state="ID");continue;case "NOTE":l||(h.state="ID");continue;case "ID":if(/^NOTE($|[ \t])/.test(l)){h.state="NOTE";break}if(!l)continue;h.cue=new (h.vttjs.VTTCue||h.window.VTTCue)(0,0,"");h.state="CUE";if(-1===l.indexOf("--\x3e")){h.cue.id=l;continue}case "CUE":try{f(l,h.cue,h.regionList)}catch(n){h.reportOrThrowError(n);h.cue=null;h.state="BADCUE";continue}h.state="CUETEXT";continue;case "CUETEXT":var p=-1!==l.indexOf("--\x3e");if(!l||
p&&(a=!0)){h.oncue&&h.oncue(h.cue);h.cue=null;h.state="ID";continue}h.cue.text&&(h.cue.text+="\n");h.cue.text+=l;continue;case "BADCUE":l||(h.state="ID")}}}catch(n){h.reportOrThrowError(n);if("CUETEXT"===h.state&&h.cue&&h.oncue)h.oncue(h.cue);h.cue=null;h.state="INITIAL"===h.state?"BADWEBVTT":"BADCUE"}return this},flush:function(){try{this.buffer+=this.decoder.decode();if(this.cue||"HEADER"===this.state)this.buffer+="\n\n",this.parse();if("INITIAL"===this.state)throw new b(b.Errors.BadSignature);
}catch(a){this.reportOrThrowError(a)}this.onflush&&this.onflush();return this}};a.WebVTT=p})(this,this.vttjs||{});
(function(a,b){var c={catchMethods:{methodreturn:[],count:0},init:function(b){var c,f;b.originalEvent.origin.match(/vimeo/g)&&"data"in b.originalEvent&&(f="string"===a.type(b.originalEvent.data)?a.parseJSON(b.originalEvent.data):b.originalEvent.data)&&(b=this.setPlayerID(f),b.length&&(c=this.setVimeoAPIurl(b),f.hasOwnProperty("event")&&this.handleEvent(f,b,c),f.hasOwnProperty("method")&&this.handleMethod(f,b,c)))},setPlayerID:function(b){return a("iframe[src*="+b.player_id+"]")},setVimeoAPIurl:function(a){return"http"!==
a.attr("src").substr(0,4)?"https:"+a.attr("src").split("?")[0]:a.attr("src").split("?")[0]},handleMethod:function(a,b,c){this.catchMethods.methodreturn.push(a.value)},handleEvent:function(b,c,f){switch(b.event.toLowerCase()){case "ready":for(var g in a._data(c[0],"events"))g.match(/loadProgress|playProgress|play|pause|finish|seek|cuechange/)&&c[0].contentWindow.postMessage(JSON.stringify({method:"addEventListener",value:g}),f);if(c.data("vimeoAPICall")){b=c.data("vimeoAPICall");for(f=0;f<b.length;f++)c[0].contentWindow.postMessage(JSON.stringify(b[f].message),
b[f].api);c.removeData("vimeoAPICall")}c.data("vimeoReady",!0);c.triggerHandler("ready");break;case "seek":c.triggerHandler("seek",[b.data]);break;case "loadprogress":c.triggerHandler("loadProgress",[b.data]);break;case "playprogress":c.triggerHandler("playProgress",[b.data]);break;case "pause":c.triggerHandler("pause");break;case "finish":c.triggerHandler("finish");break;case "play":c.triggerHandler("play");break;case "cuechange":c.triggerHandler("cuechange")}}};jQuery(document).ready(function(){a("iframe[src*='vimeo.com']").each(function(b){var c=
a(this).attr("src");if(null===c.match(/player_id/g)){var f=-1===c.indexOf("?")?"?":"&";b=a.param({api:1,player_id:"vvvvimeoVideo-"+b});a(this).attr("src",c+f+b)}})});a(b).on("message",function(a){c.init(a)});a.vimeo=function(a,e,f){var g={},h=c.catchMethods.methodreturn.length;"string"===typeof e&&(g.method=e);"function"!==typeof f&&(g.value=f);if("iframe"===a.prop("tagName").toLowerCase()&&g.hasOwnProperty("method"))if(a.data("vimeoReady"))a[0].contentWindow.postMessage(JSON.stringify(g),c.setVimeoAPIurl(a));
else{var k=a.data("vimeoAPICall")?a.data("vimeoAPICall"):[];k.push({message:g,api:c.setVimeoAPIurl(a)});a.data("vimeoAPICall",k)}"get"!==e.toString().substr(0,3)&&"paused"!==e.toString()||"function"!==typeof f||(function(a,d,e){var f=b.setInterval(function(){c.catchMethods.methodreturn.length!=a&&(b.clearInterval(f),d(c.catchMethods.methodreturn[e]))},10)}(h,f,c.catchMethods.count),c.catchMethods.count++);return a};a.fn.vimeo=function(b,c){return a.vimeo(this,b,c)}})(jQuery,window);
(function(){var a=this,b=a.Chart,c=function(a){this.canvas=a.canvas;this.ctx=a;var b=function(a,b){return a["offset"+b]?a["offset"+b]:document.defaultView.getComputedStyle(a).getPropertyValue(b)},c=this.width=b(a.canvas,"Width"),b=this.height=b(a.canvas,"Height");a.canvas.width=c;a.canvas.height=b;c=this.width=a.canvas.width;b=this.height=a.canvas.height;this.aspectRatio=this.width/this.height;d.retinaScale(this);return this};c.defaults={global:{animation:!0,animationSteps:60,animationEasing:"easeOutQuart",
...
onAnimationProgress:function(){},onAnimationComplete:function(){}}};c.types={};var d=c.helpers={},e=d.each=function(a,b,c){var d=Array.prototype.slice.call(arguments,3);if(a)if(a.length===+a.length){var e;for(e=0;e<a.length;e++)b.apply(c,[a[e],e].concat(d))}else for(e in a)b.apply(c,[a[e],e].concat(d))},f=d.clone=function(a){var b={};e(a,function(c,d){a.hasOwnProperty(d)&&(b[d]=c)});return b},g=d.extend=function(a){e(Array.prototype.slice.call(arguments,1),function(b){e(b,function(c,d){b.hasOwnProperty(d)&&
(a[d]=c)})});return a},h=d.merge=function(a,b){var c=Array.prototype.slice.call(arguments,0);c.unshift({});return g.apply(null,c)},k=d.indexOf=function(a,b){if(Array.prototype.indexOf)return a.indexOf(b);for(var c=0;c<a.length;c++)if(a[c]===b)return c;return-1};d.where=function(a,b){var c=[];d.each(a,function(a){b(a)&&c.push(a)});return c};d.findNextWhere=function(a,b,c){c||(c=-1);for(c+=1;c<a.length;c++){var d=a[c];if(b(d))return d}};d.findPreviousWhere=function(a,b,c){c||(c=a.length);for(--c;0<=
c;c--){var d=a[c];if(b(d))return d}};var m=d.inherits=function(a){var b=this,c=a&&a.hasOwnProperty("constructor")?a.constructor:function(){return b.apply(this,arguments)},d=function(){this.constructor=c};d.prototype=b.prototype;c.prototype=new d;c.extend=m;a&&g(c.prototype,a);c.__super__=b.prototype;return c},l=d.noop=function(){},p=d.uid=function(){var a=0;return function(){return"chart-"+a++}}(),n=d.warn=function(a){window.console&&"function"==typeof window.console.warn&&console.warn(a)},q=d.amd=
"function"==typeof define&&define.amd,r=d.isNumber=function(a){return!isNaN(parseFloat(a))&&isFinite(a)},x=d.max=function(a){return Math.max.apply(Math,a)},y=d.min=function(a){return Math.min.apply(Math,a)};d.cap=function(a,b,c){if(r(b)){if(a>b)return b}else if(r(c)&&a<c)return c;return a};var D=d.getDecimalPlaces=function(a){return 0!==a%1&&r(a)?a.toString().split(".")[1].length:0},E=d.radians=function(a){return Math.PI/180*a};d.getAngleFromPoint=function(a,b){var c=b.x-a.x,d=b.y-a.y,e=Math.sqrt(c*
c+d*d),f=2*Math.PI+Math.atan2(d,c);0>c&&0>d&&(f+=2*Math.PI);return{angle:f,distance:e}};var F=d.aliasPixel=function(a){return 0===a%2?0:.5};d.splineCurve=function(a,b,c,d){var e=Math.sqrt(Math.pow(b.x-a.x,2)+Math.pow(b.y-a.y,2)),f=Math.sqrt(Math.pow(c.x-b.x,2)+Math.pow(c.y-b.y,2)),g=d*e/(e+f);d=d*f/(e+f);return{inner:{x:b.x-g*(c.x-a.x),y:b.y-g*(c.y-a.y)},outer:{x:b.x+d*(c.x-a.x),y:b.y+d*(c.y-a.y)}}};var H=d.calculateOrderOfMagnitude=function(a){return Math.floor(Math.log(a)/Math.LN10)};d.calculateScaleRange=
function(a,b,c,d,e){b=Math.floor(b/(1.5*c));c=2>=b;var f=x(a),g=y(a);f===g&&(f+=.5,.5<=g&&!d?g-=.5:f+=.5);a=H(Math.abs(f-g));d=d?0:Math.floor(g/(1*Math.pow(10,a)))*Math.pow(10,a);for(var f=Math.ceil(f/(1*Math.pow(10,a)))*Math.pow(10,a)-d,g=Math.pow(10,a),h=Math.round(f/g);(h>b||2*h<b)&&!c;)if(h>b)g*=2,h=Math.round(f/g),0!==h%1&&(c=!0);else if(e&&0<=a)if(0===g/2%1)g/=2,h=Math.round(f/g);else break;else g/=2,h=Math.round(f/g);c&&(h=2,g=f/h);return{steps:h,stepValue:g,min:d,max:d+h*g}};var C=d.template=
function(a,b){if(a instanceof Function)return a(b);var c={},c=/\W/.test(a)?new Function("obj","var p=[],print=function(){p.push.apply(p,arguments);};with(obj){p.push('"+a.replace(/[\r\t\n]/g," ").split("<%").join("\t").replace(/((^|%>)[^\t]*)'/g,"$1\r").replace(/\t=(.*?)%>/g,"',$1,'").split("\t").join("');").split("%>").join("p.push('").split("\r").join("\\'")+"');}return p.join('');"):c[a]=c[a];return b?c(b):c};d.generateLabels=function(a,b,c,d){var f=Array(b);labelTemplateString&&e(f,function(b,
e){f[e]=C(a,{value:c+d*(e+1)})});return f};var z=d.easingEffects={linear:function(a){return a},easeInQuad:function(a){return a*a},easeOutQuad:function(a){return-1*a*(a-2)},easeInOutQuad:function(a){return 1>(a/=.5)?.5*a*a:-.5*(--a*(a-2)-1)},easeInCubic:function(a){return a*a*a},easeOutCubic:function(a){return 1*((a=a/1-1)*a*a+1)},easeInOutCubic:function(a){return 1>(a/=.5)?.5*a*a*a:.5*((a-=2)*a*a+2)},easeInQuart:function(a){return a*a*a*a},easeOutQuart:function(a){return-1*((a=a/1-1)*a*a*a-1)},easeInOutQuart:function(a){return 1>
...
(1*a-b)*Math.PI/c):d*Math.pow(2,-10*--a)*Math.sin(2*(1*a-b)*Math.PI/c)*.5+1},easeInBack:function(a){return 1*(a/=1)*a*(2.70158*a-1.70158)},easeOutBack:function(a){return 1*((a=a/1-1)*a*(2.70158*a+1.70158)+1)},easeInOutBack:function(a){var b=1.70158;return 1>(a/=.5)?.5*a*a*(((b*=1.525)+1)*a-b):.5*((a-=2)*a*(((b*=1.525)+1)*a+b)+2)},easeInBounce:function(a){return 1-z.easeOutBounce(1-a)},easeOutBounce:function(a){return(a/=1)<1/2.75?7.5625*a*a:a<2/2.75?1*(7.5625*(a-=1.5/2.75)*a+.75):a<2.5/2.75?1*(7.5625*
(a-=2.25/2.75)*a+.9375):1*(7.5625*(a-=2.625/2.75)*a+.984375)},easeInOutBounce:function(a){return.5>a?.5*z.easeInBounce(2*a):.5*z.easeOutBounce(2*a-1)+.5}},G=d.requestAnimFrame=function(){return window.requestAnimationFrame||window.webkitRequestAnimationFrame||window.mozRequestAnimationFrame||window.oRequestAnimationFrame||window.msRequestAnimationFrame||function(a){return window.setTimeout(a,1E3/60)}}(),I=d.cancelAnimFrame=function(){return window.cancelAnimationFrame||window.webkitCancelAnimationFrame||
window.mozCancelAnimationFrame||window.oCancelAnimationFrame||window.msCancelAnimationFrame||function(a){return window.clearTimeout(a,1E3/60)}}();d.animationLoop=function(a,b,c,d,e,f){var g=0,h=z[c]||z.linear,l=function(){g++;var c=g/b,B=h(c);a.call(f,B,c,g);d.call(f,B,c);g<b?f.animationFrame=G(l):e.apply(f)};G(l)};d.getRelativePosition=function(a){var b;b=a.originalEvent||a;var c=(a.currentTarget||a.srcElement).getBoundingClientRect();b.touches?(a=b.touches[0].clientX-c.left,b=b.touches[0].clientY-
c.top):(a=b.clientX-c.left,b=b.clientY-c.top);return{x:a,y:b}};var J=d.addEvent=function(a,b,c){a.addEventListener?a.addEventListener(b,c):a.attachEvent?a.attachEvent("on"+b,c):a["on"+b]=c},K=d.removeEvent=function(a,b,c){a.removeEventListener?a.removeEventListener(b,c,!1):a.detachEvent?a.detachEvent("on"+b,c):a["on"+b]=l};d.bindEvents=function(a,b,c){a.events||(a.events={});e(b,function(b){a.events[b]=function(){c.apply(a,arguments)};J(a.chart.canvas,b,a.events[b])})};var L=d.unbindEvents=function(a,
b){e(b,function(b,c){K(a.chart.canvas,c,b)})},M=d.getMaximumWidth=function(a){return a.parentNode.clientWidth},N=d.getMaximumHeight=function(a){return a.parentNode.clientHeight};d.getMaximumSize=d.getMaximumWidth;var O=d.retinaScale=function(a){var b=a.ctx,c=a.canvas.width;a=a.canvas.height;window.devicePixelRatio&&(b.canvas.style.width=c+"px",b.canvas.style.height=a+"px",b.canvas.height=a*window.devicePixelRatio,b.canvas.width=c*window.devicePixelRatio,b.scale(window.devicePixelRatio,window.devicePixelRatio))},
P=d.clear=function(a){a.ctx.clearRect(0,0,a.width,a.height)},t=d.fontString=function(a,b,c){return b+" "+a+"px "+c},u=d.longestText=function(a,b,c){a.font=b;var d=0;e(c,function(b){b=a.measureText(b).width;d=b>d?b:d});return d},w=d.drawRoundedRectangle=function(a,b,c,d,e,f){a.beginPath();a.moveTo(b+f,c);a.lineTo(b+d-f,c);a.quadraticCurveTo(b+d,c,b+d,c+f);a.lineTo(b+d,c+e-f);a.quadraticCurveTo(b+d,c+e,b+d-f,c+e);a.lineTo(b+f,c+e);a.quadraticCurveTo(b,c+e,b,c+e-f);a.lineTo(b,c+f);a.quadraticCurveTo(b,
c,b+f,c);a.closePath()};c.instances={};c.Type=function(a,b,d){this.options=b;this.chart=d;this.id=p();c.instances[this.id]=this;b.responsive&&this.resize();this.initialize.call(this,a)};g(c.Type.prototype,{initialize:function(){return this},clear:function(){P(this.chart);return this},stop:function(){I(this.animationFrame);return this},resize:function(a){this.stop();var b=this.chart.canvas,c=M(this.chart.canvas),d=this.options.maintainAspectRatio?c/this.chart.aspectRatio:N(this.chart.canvas);b.width=
this.chart.width=c;b.height=this.chart.height=d;O(this.chart);"function"===typeof a&&a.apply(this,Array.prototype.slice.call(arguments,1));return this},reflow:l,render:function(a){a&&this.reflow();this.options.animation&&!a?d.animationLoop(this.draw,this.options.animationSteps,this.options.animationEasing,this.options.onAnimationProgress,this.options.onAnimationComplete,this):(this.draw(),this.options.onAnimationComplete.call(this));return this},generateLegend:function(){return C(this.options.legendTemplate,
this)},destroy:function(){this.clear();L(this,this.events);var a=this.chart.canvas;a.width=this.chart.width;a.height=this.chart.height;a.style.removeProperty?(a.style.removeProperty("width"),a.style.removeProperty("height")):(a.style.removeAttribute("width"),a.style.removeAttribute("height"));delete c.instances[this.id]},showTooltip:function(a,b){"undefined"===typeof this.activeElements&&(this.activeElements=[]);if(function(a){var b=!1;if(a.length!==this.activeElements.length)return b=!0;e(a,function(a,
c){a!==this.activeElements[c]&&(b=!0)},this);return b}.call(this,a)||b){this.activeElements=a;this.draw();this.options.customTooltips&&this.options.customTooltips(!1);if(0<a.length)if(this.datasets&&1<this.datasets.length){for(var f,g,h=this.datasets.length-1;0<=h&&(f=this.datasets[h].points||this.datasets[h].bars||this.datasets[h].segments,g=k(f,a[0]),-1===g);h--);var l=[],m=[];f=function(a){var b=[],c,e=[],f=[],A,h,v;d.each(this.datasets,function(a){c=a.points||a.bars||a.segments;c[g]&&c[g].hasValue()&&
b.push(c[g])});d.each(b,function(a){e.push(a.x);f.push(a.y);l.push(d.template(this.options.multiTooltipTemplate,a));m.push({fill:a._saved.fillColor||a.fillColor,stroke:a._saved.strokeColor||a.strokeColor})},this);v=y(f);A=x(f);h=y(e);a=x(e);return{x:h>this.chart.width/2?h:a,y:(v+A)/2}}.call(this,g);(new c.MultiTooltip({x:f.x,y:f.y,xPadding:this.options.tooltipXPadding,yPadding:this.options.tooltipYPadding,xOffset:this.options.tooltipXOffset,fillColor:this.options.tooltipFillColor,textColor:this.options.tooltipFontColor,
fontFamily:this.options.tooltipFontFamily,fontStyle:this.options.tooltipFontStyle,fontSize:this.options.tooltipFontSize,titleTextColor:this.options.tooltipTitleFontColor,titleFontFamily:this.options.tooltipTitleFontFamily,titleFontStyle:this.options.tooltipTitleFontStyle,titleFontSize:this.options.tooltipTitleFontSize,cornerRadius:this.options.tooltipCornerRadius,labels:l,legendColors:m,legendColorBackground:this.options.multiTooltipKeyBackground,title:a[0].label,chart:this.chart,ctx:this.chart.ctx,
...
text:C(this.options.tooltipTemplate,a),chart:this.chart,custom:this.options.customTooltips})).draw()},this);return this}},toBase64Image:function(){return this.chart.canvas.toDataURL.apply(this.chart.canvas,arguments)}});c.Type.extend=function(a){var b=this,d=function(){return b.apply(this,arguments)};d.prototype=f(b.prototype);g(d.prototype,a);d.extend=c.Type.extend;if(a.name||b.prototype.name){var e=a.name||b.prototype.name,l=c.defaults[b.prototype.name]?f(c.defaults[b.prototype.name]):{};c.defaults[e]=
g(l,a.defaults);c.types[e]=d;c.prototype[e]=function(a,b){var f=h(c.defaults.global,c.defaults[e],b||{});return new d(a,f,this)}}else n("Name not provided for this chart, so it hasn't been registered");return b};c.Element=function(a){g(this,a);this.initialize.apply(this,arguments);this.save()};g(c.Element.prototype,{initialize:function(){},restore:function(a){a?e(a,function(a){this[a]=this._saved[a]},this):g(this,this._saved);return this},save:function(){this._saved=f(this);delete this._saved._saved;
return this},update:function(a){e(a,function(a,b){this._saved[b]=this[b];this[b]=a},this);return this},transition:function(a,b){e(a,function(a,c){this[c]=(a-this._saved[c])*b+this._saved[c]},this);return this},tooltipPosition:function(){return{x:this.x,y:this.y}},hasValue:function(){return r(this.value)}});c.Element.extend=m;c.Point=c.Element.extend({display:!0,inRange:function(a,b){return Math.pow(a-this.x,2)+Math.pow(b-this.y,2)<Math.pow(this.hitDetectionRadius+this.radius,2)},draw:function(){if(this.display){var a=
...
this.chart.ctx;a.font=t(this.fontSize,this.fontStyle,this.fontFamily);this.xAlign="center";this.yAlign="above";var b=this.caretPadding=2,c=a.measureText(this.text).width+2*this.xPadding,d=this.fontSize+2*this.yPadding,e=d+this.caretHeight+b;this.x+c/2>this.chart.width?this.xAlign="left":0>this.x-c/2&&(this.xAlign="right");0>this.y-e&&(this.yAlign="below");var f=this.x-c/2,e=this.y-e;a.fillStyle=this.fillColor;if(this.custom)this.custom(this);else{switch(this.yAlign){case "above":a.beginPath();a.moveTo(this.x,
...
else{w(this.ctx,this.x,this.y-this.height/2,this.width,this.height,this.cornerRadius);var a=this.ctx;a.fillStyle=this.fillColor;a.fill();a.closePath();a.textAlign="left";a.textBaseline="middle";a.fillStyle=this.titleTextColor;a.font=this.titleFont;a.fillText(this.title,this.x+this.xPadding,this.getLineHeight(0));a.font=this.font;d.each(this.labels,function(b,c){a.fillStyle=this.textColor;a.fillText(b,this.x+this.xPadding+this.fontSize+3,this.getLineHeight(c+1));a.fillStyle=this.legendColorBackground;
a.fillRect(this.x+this.xPadding,this.getLineHeight(c+1)-this.fontSize/2,this.fontSize,this.fontSize);a.fillStyle=this.legendColors[c].fill;a.fillRect(this.x+this.xPadding,this.getLineHeight(c+1)-this.fontSize/2,this.fontSize,this.fontSize)},this)}}});c.Scale=c.Element.extend({initialize:function(){this.fit()},buildYLabels:function(){this.yLabels=[];for(var a=D(this.stepValue),b=0;b<=this.steps;b++)this.yLabels.push(C(this.templateString,{value:(this.min+b*this.stepValue).toFixed(a)}));this.yLabelWidth=
...
this.font,this.xLabels),d;this.xLabelWidth=c;for(var e=Math.floor(this.calculateX(1)-this.calculateX(0))-6;this.xLabelWidth>e&&0===this.xLabelRotation||this.xLabelWidth>e&&90>=this.xLabelRotation&&0<this.xLabelRotation;)d=Math.cos(E(this.xLabelRotation)),b=d*a,b+this.fontSize/2>this.yLabelWidth+8&&(this.xScalePaddingLeft=b+this.fontSize/2),this.xScalePaddingRight=this.fontSize/2,this.xLabelRotation++,this.xLabelWidth=d*c;0<this.xLabelRotation&&(this.endPoint-=Math.sin(E(this.xLabelRotation))*c+3)}else this.xLabelWidth=
0,this.xScalePaddingLeft=this.xScalePaddingRight=this.padding},calculateYRange:l,drawingArea:function(){return this.startPoint-this.endPoint},calculateY:function(a){var b=this.drawingArea()/(this.min-this.max);return this.endPoint-b*(a-this.min)},calculateX:function(a){var b=(this.width-(this.xScalePaddingLeft+this.xScalePaddingRight))/Math.max(this.valuesCount-(this.offsetGridLines?0:1),1);a=b*a+this.xScalePaddingLeft;this.offsetGridLines&&(a+=b/2);return Math.round(a)},update:function(a){d.extend(this,
a);this.fit()},draw:function(){var a=this.ctx,b=(this.endPoint-this.startPoint)/this.steps,c=Math.round(this.xScalePaddingLeft);this.display&&(a.fillStyle=this.textColor,a.font=this.font,e(this.yLabels,function(e,f){var g=this.endPoint-b*f,h=Math.round(g),l=this.showHorizontalLines;a.textAlign="right";a.textBaseline="middle";this.showLabels&&a.fillText(e,c-10,g);0!==f||l||(l=!0);l&&a.beginPath();0<f?(a.lineWidth=this.gridLineWidth,a.strokeStyle=this.gridLineColor):(a.lineWidth=this.lineWidth,a.strokeStyle=
this.lineColor);h+=d.aliasPixel(a.lineWidth);l&&(a.moveTo(c,h),a.lineTo(this.width,h),a.stroke(),a.closePath());a.lineWidth=this.lineWidth;a.strokeStyle=this.lineColor;a.beginPath();a.moveTo(c-5,h);a.lineTo(c,h);a.stroke();a.closePath()},this),e(this.xLabels,function(b,c){var d=this.calculateX(c)+F(this.lineWidth),e=this.calculateX(c-(this.offsetGridLines?.5:0))+F(this.lineWidth),f=0<this.xLabelRotation,g=this.showVerticalLines;0!==c||g||(g=!0);g&&a.beginPath();0<c?(a.lineWidth=this.gridLineWidth,
a.strokeStyle=this.gridLineColor):(a.lineWidth=this.lineWidth,a.strokeStyle=this.lineColor);g&&(a.moveTo(e,this.endPoint),a.lineTo(e,this.startPoint-3),a.stroke(),a.closePath());a.lineWidth=this.lineWidth;a.strokeStyle=this.lineColor;a.beginPath();a.moveTo(e,this.endPoint);a.lineTo(e,this.endPoint+5);a.stroke();a.closePath();a.save();a.translate(d,f?this.endPoint+12:this.endPoint+8);a.rotate(-1*E(this.xLabelRotation));a.font=this.font;a.textAlign=f?"right":"center";a.textBaseline=f?"middle":"top";
a.fillText(b,0,0);a.restore()},this))}});c.RadialScale=c.Element.extend({initialize:function(){this.size=y([this.height,this.width]);this.drawingArea=this.display?this.size/2-(this.fontSize/2+this.backdropPaddingY):this.size/2},calculateCenterOffset:function(a){return this.drawingArea/(this.max-this.min)*(a-this.min)},update:function(){this.lineArc?this.drawingArea=this.display?this.size/2-(this.fontSize/2+this.backdropPaddingY):this.size/2:this.setScaleSize();this.buildYLabels()},buildYLabels:function(){this.yLabels=
[];for(var a=D(this.stepValue),b=0;b<=this.steps;b++)this.yLabels.push(C(this.templateString,{value:(this.min+b*this.stepValue).toFixed(a)}))},getCircumference:function(){return 2*Math.PI/this.valuesCount},setScaleSize:function(){var a=y([this.height/2-this.pointLabelFontSize-5,this.width/2]),b,c,d,e=this.width,f,g=0,h;this.ctx.font=t(this.pointLabelFontSize,this.pointLabelFontStyle,this.pointLabelFontFamily);for(c=0;c<this.valuesCount;c++)b=this.getPointPosition(c,a),d=this.ctx.measureText(C(this.templateString,
{value:this.labels[c]})).width+5,0===c||c===this.valuesCount/2?(d/=2,b.x+d>e&&(e=b.x+d,f=c),b.x-d<g&&(g=b.x-d,h=c)):c<this.valuesCount/2?b.x+d>e&&(e=b.x+d,f=c):c>this.valuesCount/2&&b.x-d<g&&(g=b.x-d,h=c);b=g;e=Math.ceil(e-this.width);f=this.getIndexAngle(f);h=this.getIndexAngle(h);f=e/Math.sin(f+Math.PI/2);h=b/Math.sin(h+Math.PI/2);f=r(f)?f:0;h=r(h)?h:0;this.drawingArea=a-(h+f)/2;this.setCenterPoint(h,f)},setCenterPoint:function(a,b){this.xCenter=(a+this.drawingArea+(this.width-b-this.drawingArea))/
2;this.yCenter=this.height/2},getIndexAngle:function(a){return 2*Math.PI/this.valuesCount*a-Math.PI/2},getPointPosition:function(a,b){var c=this.getIndexAngle(a);return{x:Math.cos(c)*b+this.xCenter,y:Math.sin(c)*b+this.yCenter}},draw:function(){if(this.display){var a=this.ctx;e(this.yLabels,function(b,c){if(0<c){var d=this.drawingArea/this.steps*c,e=this.yCenter-d;if(0<this.lineWidth){a.strokeStyle=this.lineColor;a.lineWidth=this.lineWidth;if(this.lineArc)a.beginPath(),a.arc(this.xCenter,this.yCenter,
d,0,2*Math.PI);else{a.beginPath();for(var f=0;f<this.valuesCount;f++)d=this.getPointPosition(f,this.calculateCenterOffset(this.min+c*this.stepValue)),0===f?a.moveTo(d.x,d.y):a.lineTo(d.x,d.y)}a.closePath();a.stroke()}this.showLabels&&(a.font=t(this.fontSize,this.fontStyle,this.fontFamily),this.showLabelBackdrop&&(d=a.measureText(b).width,a.fillStyle=this.backdropColor,a.fillRect(this.xCenter-d/2-this.backdropPaddingX,e-this.fontSize/2-this.backdropPaddingY,d+2*this.backdropPaddingX,this.fontSize+
...
5);a.font=t(this.pointLabelFontSize,this.pointLabelFontStyle,this.pointLabelFontFamily);a.fillStyle=this.pointLabelFontColor;var d=this.labels.length,f=this.labels.length/2,g=f/2,h=b<g||b>d-g,d=b===g||b===d-g;a.textAlign=0===b?"center":b===f?"center":b<f?"left":"right";a.textBaseline=d?"middle":h?"bottom":"top";a.fillText(this.labels[b],c.x,c.y)}}}}});d.addEvent(window,"resize",function(){var a;return function(){clearTimeout(a);a=setTimeout(function(){e(c.instances,function(a){a.options.responsive&&
a.resize(a.render,!0)})},50)}}());q?define(function(){return c}):"object"===typeof module&&module.exports&&(module.exports=c);a.Chart=c;c.noConflict=function(){a.Chart=b;return c}}).call(this);
...
this.options;this.ScaleClass=a.Scale.extend({offsetGridLines:!0,calculateBarX:function(a,b,c){var h=this.calculateBaseWidth();c=this.calculateX(c)-h/2;a=this.calculateBarWidth(a);return c+a*b+b*d.barDatasetSpacing+a/2},calculateBaseWidth:function(){return this.calculateX(1)-this.calculateX(0)-2*d.barValueSpacing},calculateBarWidth:function(a){return(this.calculateBaseWidth()-(a-1)*d.barDatasetSpacing)/a}});this.datasets=[];this.options.showTooltips&&b.bindEvents(this,this.options.tooltipEvents,function(a){a=
"mouseout"!==a.type?this.getBarsAtEvent(a):[];this.eachBars(function(a){a.restore(["fillColor","strokeColor"])});b.each(a,function(a){a.fillColor=a.highlightFill;a.strokeColor=a.highlightStroke});this.showTooltip(a)});this.BarClass=a.Rectangle.extend({strokeWidth:this.options.barStrokeWidth,showStroke:this.options.barShowStroke,ctx:this.chart.ctx});b.each(c.datasets,function(a,d){var g={label:a.label||null,fillColor:a.fillColor,strokeColor:a.strokeColor,bars:[]};this.datasets.push(g);b.each(a.data,
function(b,d){g.bars.push(new this.BarClass({value:b,label:c.labels[d],datasetLabel:a.label,strokeColor:a.strokeColor,fillColor:a.fillColor,highlightFill:a.highlightFill||a.fillColor,highlightStroke:a.highlightStroke||a.strokeColor}))},this)},this);this.buildScale(c.labels);this.BarClass.prototype.base=this.scale.endPoint;this.eachBars(function(a,c,d){b.extend(a,{width:this.scale.calculateBarWidth(this.datasets.length),x:this.scale.calculateBarX(this.datasets.length,d,c),y:this.scale.endPoint});a.save()},
this);this.render()},update:function(){this.scale.update();b.each(this.activeElements,function(a){a.restore(["fillColor","strokeColor"])});this.eachBars(function(a){a.save()});this.render()},eachBars:function(a){b.each(this.datasets,function(d,e){b.each(d.bars,a,this,e)},this)},getBarsAtEvent:function(a){var d=[];a=b.getRelativePosition(a);for(var e=function(a){d.push(a.bars[f])},f,g=0;g<this.datasets.length;g++)for(f=0;f<this.datasets[g].bars.length;f++)if(this.datasets[g].bars[f].inRange(a.x,a.y))return b.each(this.datasets,
e),d;return d},buildScale:function(a){var d=this,e=function(){var a=[];d.eachBars(function(b){a.push(b.value)});return a};a={templateString:this.options.scaleLabel,height:this.chart.height,width:this.chart.width,ctx:this.chart.ctx,textColor:this.options.scaleFontColor,fontSize:this.options.scaleFontSize,fontStyle:this.options.scaleFontStyle,fontFamily:this.options.scaleFontFamily,valuesCount:a.length,beginAtZero:this.options.scaleBeginAtZero,integersOnly:this.options.scaleIntegersOnly,calculateYRange:function(a){a=
...
reflow:function(){b.extend(this.BarClass.prototype,{y:this.scale.endPoint,base:this.scale.endPoint});var a=b.extend({height:this.chart.height,width:this.chart.width});this.scale.update(a)},draw:function(a){var d=a||1;this.clear();this.scale.draw(d);b.each(this.datasets,function(a,c){b.each(a.bars,function(a,b){a.hasValue()&&(a.base=this.scale.endPoint,a.transition({x:this.scale.calculateBarX(this.datasets.length,c,b),y:this.scale.calculateY(a.value),width:this.scale.calculateBarWidth(this.datasets.length)},
...
"strokeColor"])});b.each(a,function(a){a.fillColor=a.highlightFill;a.strokeColor=a.highlightStroke});this.showTooltip(a)});b.each(c.datasets,function(a){var e={label:a.label||null,fillColor:a.fillColor,strokeColor:a.strokeColor,pointColor:a.pointColor,pointStrokeColor:a.pointStrokeColor,points:[]};this.datasets.push(e);b.each(a.data,function(b,g){e.points.push(new this.PointClass({value:b,label:c.labels[g],datasetLabel:a.label,strokeColor:a.pointStrokeColor,fillColor:a.pointColor,highlightFill:a.pointHighlightFill||
...
[],e=b.getRelativePosition(a);b.each(this.datasets,function(a){b.each(a.points,function(a){a.inRange(e.x,e.y)&&d.push(a)})},this);return d},buildScale:function(c){var d=this,e=function(){var a=[];d.eachPoints(function(b){a.push(b.value)});return a};c={templateString:this.options.scaleLabel,height:this.chart.height,width:this.chart.width,ctx:this.chart.ctx,textColor:this.options.scaleFontColor,fontSize:this.options.scaleFontSize,fontStyle:this.options.scaleFontStyle,fontFamily:this.options.scaleFontFamily,
...
this);this.update()},reflow:function(){var a=b.extend({height:this.chart.height,width:this.chart.width});this.scale.update(a)},draw:function(a){var d=a||1;this.clear();var e=this.chart.ctx,f=function(a){return null!==a.value},g=function(a,c,d){return b.findNextWhere(c,f,d)||a},h=function(a,c,d){return b.findPreviousWhere(c,f,d)||a};this.scale.draw(d);b.each(this.datasets,function(a){var c=b.where(a.points,f);b.each(a.points,function(a,b){a.hasValue()&&a.transition({y:this.scale.calculateY(a.value),
x:this.scale.calculateX(b)},d)},this);this.options.bezierCurve&&b.each(c,function(a,d){var e=0<d&&d<c.length-1?this.options.bezierCurveTension:0;a.controlPoints=b.splineCurve(h(a,c,d),a,g(a,c,d),e);a.controlPoints.outer.y>this.scale.endPoint?a.controlPoints.outer.y=this.scale.endPoint:a.controlPoints.outer.y<this.scale.startPoint&&(a.controlPoints.outer.y=this.scale.startPoint);a.controlPoints.inner.y>this.scale.endPoint?a.controlPoints.inner.y=this.scale.endPoint:a.controlPoints.inner.y<this.scale.startPoint&&
(a.controlPoints.inner.y=this.scale.startPoint)},this);e.lineWidth=this.options.datasetStrokeWidth;e.strokeStyle=a.strokeColor;e.beginPath();b.each(c,function(a,b){if(0===b)e.moveTo(a.x,a.y);else if(this.options.bezierCurve){var d=h(a,c,b);e.bezierCurveTo(d.controlPoints.outer.x,d.controlPoints.outer.y,a.controlPoints.inner.x,a.controlPoints.inner.y,a.x,a.y)}else e.lineTo(a.x,a.y)},this);e.stroke();this.options.datasetFill&&0<c.length&&(e.lineTo(c[c.length-1].x,this.scale.endPoint),e.lineTo(c[0].x,
...
a.highlightFill;a.strokeColor=a.highlightStroke});this.showTooltip(a)});b.each(c.datasets,function(a){var e={label:a.label||null,fillColor:a.fillColor,strokeColor:a.strokeColor,pointColor:a.pointColor,pointStrokeColor:a.pointStrokeColor,points:[]};this.datasets.push(e);b.each(a.data,function(b,g){var h;this.scale.animation||(h=this.scale.getPointPosition(g,this.scale.calculateCenterOffset(b)));e.points.push(new this.PointClass({value:b,label:c.labels[g],datasetLabel:a.label,x:this.options.animation?
this.scale.xCenter:h.x,y:this.options.animation?this.scale.yCenter:h.y,strokeColor:a.pointStrokeColor,fillColor:a.pointColor,highlightFill:a.pointHighlightFill||a.pointColor,highlightStroke:a.pointHighlightStroke||a.pointStrokeColor}))},this)},this);this.render()},eachPoints:function(a){b.each(this.datasets,function(d){b.each(d.points,a,this)},this)},getPointsAtEvent:function(a){a=b.getRelativePosition(a);a=b.getAngleFromPoint({x:this.scale.xCenter,y:this.scale.yCenter},a);var d=Math.round((a.angle-
1.5*Math.PI)/(2*Math.PI/this.scale.valuesCount)),e=[];if(d>=this.scale.valuesCount||0>d)d=0;a.distance<=this.scale.drawingArea&&b.each(this.datasets,function(a){e.push(a.points[d])});return e},buildScale:function(b){this.scale=new a.RadialScale({display:this.options.showScale,fontStyle:this.options.scaleFontStyle,fontSize:this.options.scaleFontSize,fontFamily:this.options.scaleFontFamily,fontColor:this.options.scaleFontColor,showLabels:this.options.scaleShowLabels,showLabelBackdrop:this.options.scaleShowLabelBackdrop,
...
pointLabelFontStyle:this.options.pointLabelFontStyle,height:this.chart.height,width:this.chart.width,xCenter:this.chart.width/2,yCenter:this.chart.height/2,ctx:this.chart.ctx,templateString:this.options.scaleLabel,labels:b.labels,valuesCount:b.datasets[0].data.length});this.scale.setScaleSize();this.updateScaleRange(b.datasets);this.scale.buildYLabels()},updateScaleRange:function(a){var d=function(){var d=[];b.each(a,function(a){a.data?d=d.concat(a.data):b.each(a.points,function(a){d.push(a.value)})});
return d}(),d=this.options.scaleOverride?{steps:this.options.scaleSteps,stepValue:this.options.scaleStepWidth,min:this.options.scaleStartValue,max:this.options.scaleStartValue+this.options.scaleSteps*this.options.scaleStepWidth}:b.calculateScaleRange(d,b.min([this.chart.width,this.chart.height])/2,this.options.scaleFontSize,this.options.scaleBeginAtZero,this.options.scaleIntegersOnly);b.extend(this.scale,d)},addData:function(a,d){this.scale.valuesCount++;b.each(a,function(a,b){var c=this.scale.getPointPosition(this.scale.valuesCount,
...
(function(a){(function(){a(".wp-1").waypoint(function(){a(".wp-1").addClass("animated fadeInUp")},{offset:"75%"});a(".wp-2").waypoint(function(){a(".wp-2").addClass("animated fadeInUp")},{offset:"75%"});a(".wp-3").waypoint(function(){a(".wp-3").addClass("animated fadeInUp")},{offset:"75%"});a(".wp-4").waypoint(function(){a(".wp-4").addClass("animated fadeIn")},{offset:"75%"});a(".wp-5").waypoint(function(){a(".wp-5").addClass("animated fadeInRight")},{offset:"50%"});a(".wp-6").waypoint(function(){a(".wp-6").addClass("animated fadeInLeft")},
{offset:"50%"});a(".wp-7").waypoint(function(){a(".wp-7").addClass("animated fadeInUp")},{offset:"60%"});a(".wp-8").waypoint(function(){a(".wp-8").addClass("animated fadeInUp")},{offset:"60%"})})();a("input, textarea").placeholder();(function(){a("#collapsingMobileUser").on("show.bs.collapse",function(){a("#collapsingNavbar").removeClass("in");a('[data-target="#collapsingNavbar"]').attr("aria-expanded","false")});a("#collapsingNavbar").on("show.bs.collapse",function(){a("#collapsingMobileUser").removeClass("in");
a('[data-target="#collapsingMobileUser"]').attr("aria-expanded","false")});a("#collapsingMobileUserInverse").on("show.bs.collapse",function(){a("#collapsingNavbarInverse").removeClass("in");a('[data-target="#collapsingNavbarInverse"]').attr("aria-expanded","false")});a("#collapsingNavbarInverse").on("show.bs.collapse",function(){a("#collapsingMobileUserInverse").removeClass("in");a('[data-target="#collapsingMobileUserInverse"]').attr("aria-expanded","false")})})();(function(){a(".nav-dropdown-search").on("show.bs.dropdown",
function(){a(this).siblings().not(".navbar-nav .dropdown").addClass("sr-only")});a(".nav-dropdown-search").on("shown.bs.dropdown",function(){a(".navbar-search-input").focus()});a(".nav-dropdown-search").on("hide.bs.dropdown",function(){a(this).siblings().removeClass("sr-only")})})();(function(){videojs("demo_video",{controlBar:{timeDivider:!1,fullscreenToggle:!1,playToggle:!1,remainingTimeDisplay:!1},height:"auto",width:"auto"}).ready(function(){function a(){var b=document.getElementById(c.id()).parentElement.offsetWidth;
c.width(b).height(b*d)}var c=this,d=5/12;a();window.onresize=a})})();(function(){a(".scroll-top").on("click",function(){a("html, body").animate({scrollTop:0},1E3);return!1})})();(function(){var a=[{value:324,color:"#5e98e3",highlight:"#424753",label:"Completed"},{value:34,color:"#59d0bd",highlight:"#424753",label:"In backlog"},{value:20,color:"#e8e9ec",highlight:"#424753",label:"Without ticket"}];window.onload=function(){var c=document.getElementById("chart-area");if(null!=c)c=c.getContext("2d"),
window.myDoughnut=(new Chart(c)).Doughnut(a,{responsive:!0,percentageInnerCutout:80});else return!1}})();(function(){a("#videoModal").on("shown.bs.modal",function(){a("#vimeo-play").vimeo("play")});a("#videoModal").on("hidden.bs.modal",function(){a("#vimeo-play").vimeo("pause")});a("#youtube-trigger").click(function(){var b=a(this).attr("data-video"),c=b+"?autoplay=1&html5=1&rel=0&showinfo=0";a("#youtubeModal").on("shown.bs.modal",function(){a("#youtube-play").attr("src",c)});a("#youtubeModal").on("hidden.bs.modal",
function(){a("#youtube-play").attr("src",b)})})})()})(jQuery);